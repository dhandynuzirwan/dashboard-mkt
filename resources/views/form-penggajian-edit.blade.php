                            ...
                            <form action="{{ route('penggajian.update', $penggajian->id) }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="form-control" name="target_call"
                                            value="{{ old('target_call', $penggajian->target_call) }}" required>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" name="target"
                                                value="{{ old('target', $penggajian->target) }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" name="tunjangan"
                                                value="{{ old('tunjangan', $penggajian->tunjangan) }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" name="tunjangan_bpjs"
                                                value="{{ old('tunjangan_bpjs', $penggajian->tunjangan_bpjs ?? 0) }}" placeholder="0" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" name="iuran_bpjs"
                                                value="{{ old('iuran_bpjs', $penggajian->iuran_bpjs ?? 0) }}" placeholder="0" required>
                                        </div>
                                    </div>
