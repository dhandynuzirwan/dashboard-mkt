        ...
        <div class="sidebar-content">
            <ul class="nav nav-secondary">
                @if (in_array(auth()->user()->role, ['superadmin', 'admin', 'marketing']))
                    <li
                        class="nav-item {{ request()->routeIs('dashboard.*', 'revenue', 'data-kpi', 'simulasi-gaji') ? 'active' : '' }}">
                        ...
                        <div class="collapse {{ request()->routeIs('dashboard.*', 'revenue', 'data-kpi', 'simulasi-gaji') ? 'show' : '' }}"
                            id="dashboard">
