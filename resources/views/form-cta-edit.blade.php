                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="status_penawaran" class="form-control" required>
                                        ...
                                        <option value="hold" {{ $cta->status_penawaran == 'hold' ? 'selected' : '' }}>Hold
                                        </option>
                                        <option value="kalah_harga"
                                            {{ $cta->status_penawaran == 'kalah_harga' ? 'selected' : '' }}>Kalah Harga
                                        </option>
                                        <option value="deal" {{ $cta->status_penawaran == 'deal' ? 'selected' : '' }}>
                                            Deal</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="keterangan" class="form-control" rows="3">{{ $cta->keterangan }}</textarea>
                                </div>
                            </div>
