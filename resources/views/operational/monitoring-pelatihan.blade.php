                                    ...
                                    <tr>
                                        <td class="ps-4 cell-relative">
                                            ...
                                            <div class="fw-bolder text-dark" style="font-size: 14px;">
                                                ...
                                                @if($isSyncRiwayat) <span class="badge bg-light text-secondary border ms-1" style="font-size: 10px;">Input Manual</span> @endif
                                            </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content modal-content-modern">
            ...
            <div class="modal-body p-4 text-center">
                ...
                @php $isSyncRiwayat = $pelatihan->pendaftaranPribadis->isEmpty() && $pelatihan->riwayat; @endphp
                <p class="text-muted small mb-0">Apakah Anda yakin ingin menghapus data pelatihan <strong>{{ $isSyncRiwayat ? ($pelatihan->riwayat->judul_pelatihan ?? (optional($pelatihan->training)->nama_training ?? 'Belum Ada Pelatihan')) : (optional($pelatihan->training)->nama_training ?? 'Belum Ada Pelatihan') }}</strong>? Tindakan ini tidak dapat dibatalkan.</p>
            </div>
