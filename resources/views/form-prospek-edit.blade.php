                        ...
                        <form action="{{ route('prospek.update', $prospek->id) }}" method="POST">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" name="tanggal_prospek"
                                           value="{{ $prospek->tanggal_prospek }}"
                                           class="form-control">
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="nama_pic"
                                           value="{{ $prospek->nama_pic }}"
                                           class="form-control">
                                </div>

                                <div class="col-md-4">
                                    <label>WA PIC</label>
                                    <input type="text" name="wa_pic"
                                           value="{{ $prospek->wa_pic }}"
                                           class="form-control">
                                </div>

                                <div class="col-md-4">
                                    <label>WA Baru</label>
                                    <input type="text" name="wa_baru"
                                           value="{{ $prospek->wa_baru }}"
                                           class="form-control">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="status"
                                           value="{{ $prospek->status }}"
                                           class="form-control">
                                </div>

                                <div class="col-md-6">
                                    <label>Update Terakhir</label>
                                    <input type="text" name="update_terakhir"
                                           value="{{ $prospek->update_terakhir }}"
                                           class="form-control">
                                </div>
