...
<body class="bg-gray-50 text-gray-800 font-sans antialiased flex flex-col min-h-screen">
    ...
    <nav class="bg-white/80 backdrop-blur-md shadow-sm py-4 sticky top-0 z-30 border-b border-gray-100">
        <div class="max-w-4xl mx-auto px-5 flex items-center">
            ...
            <div>
                ...
                <p class="text-xs text-emerald-600 font-medium">Akses Khusus PIC Instansi</p>
            </div>
        </div>
    </nav>
    ...
    <main class="flex-grow px-5 py-8 w-full max-w-4xl mx-auto">
        ...
        <div id="login-section" class="w-full max-w-md mx-auto fade-in">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-sm text-gray-500 leading-relaxed">Masukkan Nama Perusahaan dan Nomor WhatsApp PIC untuk mengakses data karyawan.</p>
            </div>
                ...
                <form onsubmit="event.preventDefault(); prosesLogin();" class="space-y-6">
                    <div class="space-y-2">
                        ...
                        <div class="input-focus-ring transition-shadow rounded-xl relative">
                            ...
                            <input type="text" required class="w-full pl-11 pr-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:border-emerald-500 outline-none transition-colors text-gray-700" placeholder="Contoh: PT Arsa Jaya Prima">
                        </div>
                    </div>

                    <div class="space-y-2">
                        <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider ml-1">No. WhatsApp PIC (PIN)</label>
                        <div class="input-focus-ring transition-shadow rounded-xl relative">
                            <span class="absolute inset-y-0 left-0 flex items-center pl-4 text-gray-400">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>
                            </span>
                            <input type="tel" required class="w-full pl-11 pr-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:border-emerald-500 outline-none transition-colors tracking-widest" placeholder="0812xxxxxx">
                        </div>
                    </div>
        ...
        <div id="dashboard-section" class="hidden w-full">
            ...
            <div class="flex justify-between items-center mb-8 bg-emerald-600 p-5 rounded-3xl text-white shadow-lg shadow-emerald-600/20">
            ...
            <div class="grid grid-cols-3 gap-3 md:gap-5 mb-8">
                ...
                <div class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 text-center border-b-4 border-b-green-500">
                ...
                <div class="bg-red-50 p-4 rounded-2xl shadow-sm border border-red-100 text-center border-b-4 border-b-red-500">
            ...
            <div class="flex justify-between items-center mb-4">
                ...
                <div class="relative w-1/2 md:w-1/3">
                    ...
                    <input type="text" class="w-full pl-9 pr-3 py-2.5 bg-white border border-gray-200 rounded-xl text-xs focus:ring-2 focus:ring-emerald-500 outline-none shadow-sm" placeholder="Cari nama...">
                </div>
            </div>

            <div class="space-y-4">

                <div class="bg-white p-5 rounded-3xl shadow-sm border border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div class="flex items-center">
                        <div class="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center text-gray-500 font-bold text-lg mr-4 flex-shrink-0">DN</div>
                        <div>
                            <h3 class="text-base font-bold text-gray-900">Dhandy Nuzirwan</h3>
                            <p class="text-xs text-gray-500 mt-0.5">Web Developer & SEO</p>
                        </div>
                    </div>
                    <div class="flex items-center justify-between md:justify-end w-full md:w-auto border-t border-gray-100 md:border-t-0 pt-3 md:pt-0">
                ...
                <div class="bg-white p-5 rounded-3xl shadow-sm border-2 border-red-100 flex flex-col md:flex-row md:items-center justify-between gap-4 relative overflow-hidden">
                    <div class="absolute left-0 top-0 bottom-0 w-1.5 bg-red-500"></div>
                    <div class="flex items-center pl-2">
                        <div class="w-12 h-12 bg-red-50 rounded-full flex items-center justify-center text-red-500 font-bold text-lg mr-4 flex-shrink-0">PP</div>
                        <div>
                            <h3 class="text-base font-bold text-gray-900">Leo Pratama</h3>
                            <p class="text-xs text-gray-500 mt-0.5">UI/UX Designer</p>
                        </div>
                    </div>
                    <div class="flex items-center justify-between md:justify-end w-full md:w-auto border-t border-gray-100 md:border-t-0 pt-3 md:pt-0 pl-2">
                        <div class="flex flex-col md:items-end md:mr-4">
                            <span class="bg-red-100 text-red-700 px-3 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-wider inline-block w-max mb-1">Revisi KTP</span>
                ...
                <div class="bg-white p-5 rounded-3xl shadow-sm border border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-4 opacity-70 hover:opacity-100 transition-opacity">
                    <div class="flex items-center">
                        <div class="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center text-gray-500 font-bold text-lg mr-4 flex-shrink-0">AS</div>
                        <div>
                            <h3 class="text-base font-bold text-gray-900">Ahmad Subagyo</h3>
                            <p class="text-xs text-gray-500 mt-0.5">Marketing Officer</p>
                        </div>
                    </div>
                    <div class="flex items-center justify-between md:justify-end w-full md:w-auto border-t border-gray-100 md:border-t-0 pt-3 md:pt-0">
    ...
    <script>
        // Logika SPA: Beralih dari Login ke Dashboard
        function prosesLogin() {
            ...
            setTimeout(() => {
                // Sembunyikan Login, Munculkan Dashboard
                ...
                // Kembalikan tombol login ke semula (di belakang layar)
                btn.disabled = false;
            ...
            }, 1000); // delay 1 detik biar kerasa transisinya
        }

        // Logika SPA: Beralih kembali dari Dashboard ke Login
        function prosesLogout() {
            document.getElementById('dashboard-section').classList.add('hidden');
            document.getElementById('dashboard-section').classList.remove('fade-in'); // reset animasi
        ...
        // Logika Upload FIle di dalam modal
        ...
        function kirimRevisi() {
            ...
            resetUpload(); // bersihkan inputan untuk simulasi berikutnya
        }
    </script>
</body>
