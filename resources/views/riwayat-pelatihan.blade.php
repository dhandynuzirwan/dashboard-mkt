                    ...
                    <div class="glass-card h-100 hover-lift">
                        <div class="card-body p-4 d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <h3 class="fw-black text-dark mb-0">{{ isset($totalPeserta) ? number_format($totalPeserta) : 0 }}</h3>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="mb-1">
                                            ...
                                            @elseif($item->status_sertif == 'Belum Terbit')
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    ...
                                    @if(!$item->modul && !$item->laporan_pic && !$item->scan_sertif && !$item->bukti_kompeten && !$laporanLateText)
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-2">
                                ...
                                <div class="input-group input-group-sm">
                                    <input type="file" name="laporan_pic" id="laporan_pic_{{ $item->id }}" class="form-control form-control-modern" accept=".pdf,.doc,.docx">
                                ...
                                @if($item->laporan_pic)
                                    <div class="d-flex align-items-center mt-1">
                                        <a href="{{ getFileUrl($item->laporan_pic) }}" target="_blank" class="small text-primary me-3"><i class="fas fa-file-alt me-1"></i> Lihat Laporan Saat Ini</a>
                                        <div class="form-check form-check-inline mb-0">
