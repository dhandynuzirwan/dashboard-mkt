                                ...
                                <div class="col col-stats ms-3 ms-sm-0">
                                    <div class="numbers">
                                        ...
                                        <p class="text-success small mb-0">
                                            ...
                                            @php
                                                $rate =
                                                    $stat_total_qty > 0 ? ($stat_deal_qty / $stat_total_qty) * 100 : 0;
                                            @endphp
                                ...
                                <div class="col col-stats ms-3 ms-sm-0">
                                    <div class="numbers">
                                        ...
                                        <h4 class="card-title" style="font-size: 1.1rem;">Rp
                                            {{ number_format($stat_total_nilai, 0, ',', '.') }}</h4>
                                        <p class="text-muted small mb-0">
                                            @php
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col col-stats ms-3 ms-sm-0">
                                    <div class="numbers">
                                        ...
                                        <h4 class="card-title text-success" style="font-size: 1.1rem;">Rp
                                            {{ number_format($stat_deal_nilai, 0, ',', '.') }}</h4>
                                        <p class="text-primary small mb-0 font-weight-bold">
                                            <i class="fas fa-check-double me-1"></i>
                                            @php
                                                $realization =
                                                    $stat_total_nilai > 0
                                                        ? ($stat_deal_nilai / $stat_total_nilai) * 100
                                                        : 0;
                                            @endphp
                ...
                <form action="{{ route('dashboard.progress') }}" method="GET" class="d-flex flex-wrap gap-2">
                    ...
                    <div class="form-group p-0 m-0">
                        <select name="marketing_id" class="form-select form-select-sm">
                            ...
                            @foreach ($all_marketing as $m)
                                <option value="{{ $m->id }}"
                                    {{ request('marketing_id') == $m->id ? 'selected' : '' }}>{{ $m->name }}</option>
                            @endforeach
                        </select>
                    </div>
