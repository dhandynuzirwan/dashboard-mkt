                        ...
                        <div class="d-flex flex-column flex-md-row align-items-md-end gap-4 mb-4">
                            <div class="profile-avatar-wrapper">
                                <?php if(Auth::user()->foto_profil): ?>
                                    <img src="<?php echo e(asset('storage/' . Auth::user()->foto_profil)); ?>" alt="Profile Picture" class="profile-avatar">
                                <?php else: ?>
                            ...
                            <div class="flex-grow-1 pb-1">
                                <h3 class="fw-black text-dark mb-1"><?php echo e(Auth::user()->name); ?></h3>
                                <p class="text-primary fw-bold small mb-0 text-uppercase" style="letter-spacing: 1px;">
                                    <i class="fas fa-user-shield me-1"></i> <?php echo e(str_replace('_', ' ', Auth::user()->role ?? 'Karyawan')); ?>
                            ...
                            <div class="pb-1 dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end shadow border-0 rounded-4 p-2">
                                    <li><a class="dropdown-item rounded-3 mb-1" href="<?php echo e(route('my-profile.edit')); ?>"><i class="fas fa-user-edit me-2 text-primary"></i> Edit Profil</a></li>
                                    <li>
                        ...
                        <div class="row g-3">
                            <div class="col-sm-6 col-md-3">
                                <div class="data-diri-item h-100">
                                    ...
                                    <div class="text-dark fw-bolder"><?php echo e(Auth::user()->nik ?? '-'); ?></div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-3">
                                <div class="data-diri-item h-100">
                                    <div class="text-muted small fw-bold mb-1"><i class="fas fa-birthday-cake text-warning me-1"></i> Tanggal Lahir</div>
                                    <div class="text-dark fw-bolder"><?php echo e(Auth::user()->tanggal_lahir ? \Carbon\Carbon::parse(Auth::user()->tanggal_lahir)->translatedFormat('d M Y') : '-'); ?></div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-3">
                                <div class="data-diri-item h-100">
                                    <div class="text-muted small fw-bold mb-1"><i class="fas fa-file-signature text-info me-1"></i> Kontrak Mulai</div>
                                    <div class="text-dark fw-bolder"><?php echo e(Auth::user()->tanggal_kontrak_baru ? \Carbon\Carbon::parse(Auth::user()->tanggal_kontrak_baru)->translatedFormat('d M Y') : '-'); ?></div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-3">
                                <div class="data-diri-item h-100">
                                    <div class="text-muted small fw-bold mb-1"><i class="fas fa-hourglass-end text-danger me-1"></i> Kontrak Habis</div>
                                    <div class="text-danger fw-bolder"><?php echo e(Auth::user()->tanggal_kontrak_berakhir ? \Carbon\Carbon::parse(Auth::user()->tanggal_kontrak_berakhir)->translatedFormat('d M Y') : '-'); ?></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-4 pt-3 border-top">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                <?php $__currentLoopData = $quickAccess; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e($item['route']); ?>" class="quick-action-btn">
                                        <div class="icon-box bg-<?php echo e($item['color']); ?>-subtle text-<?php echo e($item['color']); ?> shadow-sm" style="width: 32px; height: 32px; border-radius: 8px;">
                ...
                <div class="bento-card h-100 p-4 fade-in" style="animation-delay: 0.1s;">
                    ...
                    <div class="position-relative mx-auto w-100" style="max-width: 280px; aspect-ratio: 1/1; margin-bottom: 30px; margin-top: 10px;">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle text-center" style="margin-top: 2px;">
                            <span class="d-block fw-black text-dark line-height-1" style="font-size: 2.8rem; margin-bottom: -5px;"><?php echo e($attendanceRate); ?>%</span>
                    ...
                    <div class="row text-center g-3">
                        <div class="col-4">
                            <div class="p-1 h-100">
                                ...
                                <span class="d-block fw-black fs-5 text-dark mt-1"><?php echo e($hadir); ?></span>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="p-1 h-100">
                                <span class="d-block text-warning fw-bold" style="font-size: 11px; text-transform: uppercase;">Telat</span>
                                <span class="d-block fw-black fs-5 text-dark mt-1"><?php echo e($telat); ?></span>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="p-1 h-100">
                                <span class="d-block text-danger fw-bold" style="font-size: 11px; text-transform: uppercase;">Absen</span>
                                <span class="d-block fw-black fs-5 text-dark mt-1"><?php echo e($absen); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $pengumuman; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <div class="d-flex mb-3 pb-3 <?php echo e(!$loop->last ? 'border-bottom' : ''); ?>">
                                <div class="flex-shrink-0 mt-1">
                                    <div class="bg-<?php echo e($color); ?>-subtle text-<?php echo e($color); ?> rounded-circle text-center d-flex align-items-center justify-content-center shadow-sm" style="width: 40px; height: 40px;">
                                        <i class="<?php echo e($icon); ?>"></i>
                                    </div>
                                </div>
                                <div class="flex-grow-1 ms-3">
                                    <div class="d-flex justify-content-between align-items-start mb-1">
                                        <h6 class="fw-bold text-dark mb-0 pe-2"><?php echo e($p->judul); ?></h6>
                                    ...
                                    <?php if($p->lampiran): ?>
                                        ...
                                        <div class="mt-2 mb-2 d-flex gap-2">
                                            <a href="<?php echo e($previewUrl); ?>" target="_blank" class="btn btn-sm btn-light border shadow-sm text-primary" style="font-size: 11px; padding: 4px 10px; border-radius: 8px;">
                                                <i class="fas fa-eye me-1"></i> Preview
                                            </a>
                                            <a href="<?php echo e($fileUrl); ?>" download class="btn btn-sm btn-light border shadow-sm text-secondary" style="font-size: 11px; padding: 4px 10px; border-radius: 8px;" title="Download">
                        ...
                        <div class="mt-4 pt-3 border-top scrollable-content" style="max-height: 120px;">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $upcomingAgendas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agenda): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="d-flex mb-2 align-items-center bg-light p-2 rounded-3">
                                    <div class="bg-<?php echo e($agenda['color']); ?> rounded-circle me-3" style="width:12px; height:12px; box-shadow: 0 0 5px var(--bs-<?php echo e($agenda['color']); ?>);"></div>
                                    <div class="small fw-bold text-dark flex-grow-1"><?php echo e($agenda['title']); ?></div>
                                    <span class="badge bg-white text-dark shadow-sm border"><?php echo e(\Carbon\Carbon::parse($agenda['date'])->format('d M')); ?></span>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <div class="bento-card h-100 fade-in" style="animation-delay: 0.4s;">
                    <?php if(Auth::user()->role === 'superadmin'): ?>
                        <div class="bg-transparent border-0 pt-4 pb-3 px-4 d-flex justify-content-between align-items-center">
                            ...
                            <span class="badge bg-danger rounded-pill shadow-sm"><?php echo e(count($pendingPerizinan)); ?> Baru</span>
                        </div>
                        <div class="p-4 pt-0 scrollable-content">
                            <?php if(count($pendingPerizinan) > 0): ?>
                                <div class="position-relative ms-2">
                                    ...
                                    <div class="position-relative ps-4 mb-4 z-2">
                                        <div class="position-absolute bg-<?php echo e($p['color']); ?> border border-white border-2 rounded-circle shadow-sm" style="width: 16px; height: 16px; left: -1px; top: 3px;"></div>
                                        <div class="small text-muted mb-1 fw-bold"><?php echo e(\Carbon\Carbon::parse($p['waktu'])->diffForHumans()); ?> &bull; <span class="text-<?php echo e($p['color']); ?>"><?php echo e($p['tipe']); ?></span></div>
                                        <div class="small fw-bolder text-dark bg-light p-2 rounded-3 mt-1">Diajukan: <?php echo e($p['nama']); ?></div>
                                    </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            <?php else: ?>
                        ...
                        <div class="p-4 pt-0 scrollable-content">
                            <?php if($feed->count() > 0): ?>
                                <div class="position-relative ms-2">
                                    ...
                                    <div class="position-relative ps-4 mb-4 z-2">
                                        <div class="position-absolute bg-<?php echo e($f['color']); ?> border border-white border-2 rounded-circle shadow-sm" style="width: 16px; height: 16px; left: -1px; top: 3px;"></div>
                                        <div class="small text-muted mb-1 fw-bold"><?php echo e(\Carbon\Carbon::parse($f['time'])->diffForHumans()); ?> &bull; <span class="text-<?php echo e($f['color']); ?>"><?php echo e($f['type']); ?></span></div>
                                        <div class="small fw-bolder text-dark bg-light p-2 rounded-3 mt-1"><?php echo e($f['title']); ?></div>
                                    </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            <?php else: ?>
...
<script>
    ...
    const agendas = <?php echo json_encode($upcomingAgendas, 15, 512) ?>;
