                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active text-primary" id="antrean-tab" data-bs-toggle="tab" data-bs-target="#antrean" type="button" role="tab" aria-controls="antrean" aria-selected="true">
                            ...
                            <?php if($izins->count() > 0): ?>
                                <span class="badge bg-danger ms-2 rounded-circle"><?php echo e($izins->count()); ?></span>
                            <?php endif; ?>
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $izins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $izin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="px-4 fw-bold text-dark">
                                        <?php echo e($izin->user->name ?? 'User Dihapus'); ?>
                                    ...
                                    <td class="text-end px-4">
                                        <button type="button" class="btn btn-sm btn-success shadow-sm" data-bs-toggle="modal" data-bs-target="#accModal<?php echo e($izin->id); ?>">
                                            <i class="fas fa-check"></i> ACC
                                        </button>
                                        <button type="button" class="btn btn-sm btn-danger shadow-sm ms-1" data-bs-toggle="modal" data-bs-target="#tolakModal<?php echo e($izin->id); ?>">
                                ...
                                <!-- Modal ACC -->
                                <div class="modal fade" id="accModal<?php echo e($izin->id); ?>" tabindex="-1" aria-hidden="true">
                                  <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content rounded-4 border-0 shadow">
                                      ...
                                      <div class="modal-body text-start pt-3">
                                        Apakah Anda yakin ingin <strong class="text-success">menyetujui</strong> pengajuan <?php echo e($izin->jenis); ?> dari <strong><?php echo e($izin->user->name ?? 'Pegawai'); ?></strong> pada tanggal <?php echo e(\Carbon\Carbon::parse($izin->tanggal)->format('d M Y')); ?>?
                                      </div>
                                      <div class="modal-footer border-0 pt-0">
                                        <button type="button" class="btn btn-light fw-bold rounded-3" data-bs-dismiss="modal">Batal</button>
                                        <form action="<?php echo e(route('approval-izin.approve', $izin->id)); ?>" method="POST" class="d-inline">
                                            <?php echo csrf_field(); ?>
                                ...
                                <!-- Modal Tolak -->
                                <div class="modal fade" id="tolakModal<?php echo e($izin->id); ?>" tabindex="-1" aria-hidden="true">
                                  <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content rounded-4 border-0 shadow">
                                      <div class="modal-header border-0 pb-0">
                                      ...
                                      <div class="modal-body text-start pt-3">
                                        Apakah Anda yakin ingin <strong class="text-danger">menolak</strong> pengajuan <?php echo e($izin->jenis); ?> dari <strong><?php echo e($izin->user->name ?? 'Pegawai'); ?></strong> pada tanggal <?php echo e(\Carbon\Carbon::parse($izin->tanggal)->format('d M Y')); ?>?
                                      </div>
                                      <div class="modal-footer border-0 pt-0">
                                        <button type="button" class="btn btn-light fw-bold rounded-3" data-bs-dismiss="modal">Batal</button>
                                        <form action="<?php echo e(route('approval-izin.reject', $izin->id)); ?>" method="POST" class="d-inline">
                                            <?php echo csrf_field(); ?>
            ...
            <div class="tab-pane fade" id="riwayat" role="tabpanel" aria-labelledby="riwayat-tab">
                <div class="table-responsive">
                    <table class="table table-hover table-striped align-middle mb-0">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $riwayatIzins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $riwayat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="px-4 fw-bold text-dark">
                                        <?php echo e($riwayat->user->name ?? 'User Dihapus'); ?>

                                    </td>
                                    <td class="fw-bold text-primary"><?php echo e(\Carbon\Carbon::parse($riwayat->tanggal)->format('d M Y')); ?></td>
                                    <td><?php echo e($riwayat->jenis); ?></td>
                                    <td><?php echo e($riwayat->keterangan ?? '-'); ?></td>
                                    <td>
                                        <?php if($riwayat->file_path): ?>
                                            <a href="<?php echo e(asset('storage/' . $riwayat->file_path)); ?>" target="_blank" class="btn btn-sm btn-outline-info">
                                                <i class="fas fa-file-download"></i> Lihat Bukti
                                            </a>
                                        <?php else: ?>
                                            <span class="text-muted small">Tidak ada</span>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\dashboard-mkt\resources\views/approval-izin/index.blade.php ENDPATH**/ ?>