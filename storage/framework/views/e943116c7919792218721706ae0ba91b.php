    ...
    <div class="page-inner">
        ...
        <?php if(session('success')): ?>
            <div class="alert alert-modern-success alert-dismissible fade show mb-3 fade-in" role="alert" style="padding: 12px;">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <span class="fw-bold text-dark fs-6">Berhasil!</span> <span class="text-dark opacity-75 small"><?php echo e(session('success')); ?></span>
                    </div>
                </div>
        ...
        <?php if(session('error')): ?>
            <div class="alert alert-modern-danger alert-dismissible fade show mb-3 fade-in" role="alert" style="padding: 12px; background-color: #fef2f2; border-left: 4px solid #ef4444; border-radius: 8px;">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <span class="fw-bold text-dark fs-6">Gagal!</span> <span class="text-dark opacity-75 small"><?php echo e(session('error')); ?></span>
                    </div>
                </div>
                <button type="button" class="btn-close shadow-none" data-bs-dismiss="alert" aria-label="Close" style="padding: 12px;"></button>
            </div>
        ...
        <div class="d-flex justify-content-center fade-in">
            <div class="card card-modern border-0 shadow-lg p-3 p-md-4 w-100" style="max-width: 420px; border-radius: 20px;">
                ...
                <form action="<?php echo e(route('pegawai.absensi.store')); ?>" method="POST" id="formAbsensi">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-3 d-flex justify-content-center gap-2">
                        <input type="radio" class="btn-check btn-absen-custom" name="tipe_absen" id="absen_masuk" value="in" <?php echo e(!$sudahAbsen ? 'checked' : ''); ?>>
                        ...
                        <input type="radio" class="btn-check btn-absen-custom" name="tipe_absen" id="absen_pulang" value="out" <?php echo e($sudahAbsen ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\dashboard-mkt\resources\views/absensi-kamera.blade.php ENDPATH**/ ?>