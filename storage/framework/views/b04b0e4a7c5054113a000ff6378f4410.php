                            ...
                            <div class="row align-items-stretch">
                                <div class="col-md-6 mb-3 mb-md-0 d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center p-3 rounded-3 flex-grow-1" style="background: #f4f7fe; border: 1px dashed #bac8f3;">
                                        ...
                                        <a href="<?php echo e(asset('storage/' . $item->referensi_file)); ?>" target="_blank" class="btn btn-light rounded-circle text-primary shadow-sm ms-2 d-flex align-items-center justify-content-center flex-shrink-0" style="width: 32px; height: 32px;" title="Lihat">
