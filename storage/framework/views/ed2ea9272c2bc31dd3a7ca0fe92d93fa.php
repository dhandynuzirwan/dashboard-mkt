                ...
                <div class="card glass-card h-100 border-0">
                    <div class="card-body p-3 p-xl-4 d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h3 class="fw-bolder text-dark mb-0 lh-1"><?php echo e(number_format($stats['total_aset'])); ?></h3>
                ...
                <div class="card glass-card h-100 border-0">
                    <div class="card-body p-3 p-xl-4 d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h3 class="fw-bolder text-dark mb-0 lh-1"><?php echo e(number_format($stats['jenis_item'])); ?></h3>
                ...
                <div class="card glass-card h-100 border-0">
                    <div class="card-body p-3 p-xl-4 d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h3 class="fw-bolder text-warning-dark mb-0 lh-1"><?php echo e($stats['stok_menipis']); ?> <span style="font-size: 14px;">Item</span></h3>
                ...
                <div class="card glass-card h-100 border-0">
                    <div class="card-body p-3 p-xl-4 d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h3 class="fw-bolder text-danger mb-0 lh-1"><?php echo e($stats['aset_rusak']); ?></h3>
            ...
            <div class="tab-pane fade show active" id="pills-persediaan" role="tabpanel">
                ...
                <div class="glass-card mb-4">
                    <div class="card-body p-3 p-md-4 d-flex flex-wrap justify-content-between align-items-center gap-3 bg-light" style="border-radius: 16px;">
                        <form action="<?php echo e(route('operational.inventaris')); ?>" method="GET" class="d-flex gap-2 flex-grow-1 align-items-end flex-wrap">
                            <div style="min-width: 280px; flex-grow: 1; max-width: 400px;">
                                ...
                                <div class="input-group input-group-sm shadow-sm" style="border-radius: 8px; overflow: hidden;">
                                    ...
                                    <input type="text" name="search_stok" class="form-control border-start-0 shadow-none ps-0" placeholder="Cari Nama Barang..." value="<?php echo e(request('search_stok')); ?>">
                                </div>
                            </div>
                            <button type="submit" class="btn btn-primary btn-sm btn-round fw-bold px-4 shadow-sm hover-lift">Filter</button>
                            <a href="<?php echo e(route('operational.inventaris')); ?>" class="btn btn-white btn-sm border btn-round fw-bold text-dark px-4 shadow-sm hover-lift">Reset</a>
                        </form>
                            ...
                            <table class="table table-custom table-hover align-middle mb-0 text-center">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="text-start ps-4 fw-bolder text-dark" style="font-size: 14px;"><?php echo e($item->nama); ?></td>
                                            <td><span class="badge badge-soft-secondary border text-muted px-2 py-1" style="font-size: 10px;"><?php echo e($item->kategori); ?></span></td>
                                            <td>
                                                <h4 class="mb-0 fw-bolder <?php echo e($item->stok <= $item->min_stok ? 'text-danger' : 'text-primary'); ?>">
                                                    <?php echo e(number_format($item->stok)); ?>

                                                </h4>
                                            </td>
                                            <td class="text-muted fw-bold small text-uppercase"><?php echo e($item->satuan); ?></td>
                                            <td>
                                                <?php if($item->stok <= $item->min_stok): ?>
                                                    <span class="badge badge-soft-danger border border-danger px-3 py-1 rounded-pill animate-pulse" title="Batas Minimal: <?php echo e($item->min_stok); ?>"><i class="fas fa-exclamation-circle me-1"></i> Menipis</span>
                                                <?php else: ?>
                                                    <span class="badge badge-soft-success border border-success px-3 py-1 rounded-pill" title="Batas Minimal: <?php echo e($item->min_stok); ?>"><i class="fas fa-check me-1"></i> Aman</span>
                                                <?php endif; ?>
                                            </td>
                                            <td class="text-center">
                                                <div class="d-flex gap-2 justify-content-center">
                                                    <button class="btn btn-sm btn-primary btn-round fw-bold shadow-sm hover-lift flex-grow-1 px-2" data-bs-toggle="modal" data-bs-target="#modalMutasi<?php echo e($item->id); ?>In" title="Stok Masuk (+)">
                                                        <i class="fas fa-plus"></i> In
                                                    </button>
                                                    <button class="btn btn-sm btn-warning btn-round fw-bold text-dark shadow-sm hover-lift flex-grow-1 px-2" data-bs-toggle="modal" data-bs-target="#modalMutasi<?php echo e($item->id); ?>Out" title="Stok Keluar (-)">
                                            ...
                                            <td class="text-center pe-4">
                                                <div class="d-flex gap-2 justify-content-center">
                                                    ...
                                                    <button class="btn btn-sm btn-light border text-primary btn-round shadow-sm hover-lift px-2" title="Edit Barang" data-bs-toggle="modal" data-bs-target="#modalEditPersediaan<?php echo e($item->id); ?>">
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                                                    
                                                    <form action="<?php echo e(route('inventaris.item.destroy', $item->id)); ?>" method="POST" class="d-inline form-hapus m-0 p-0">
                    ...
                    <div class="card-body p-3 p-md-4 d-flex flex-wrap justify-content-between align-items-center gap-3 bg-light" style="border-radius: 16px;">
                        <form action="<?php echo e(route('operational.inventaris')); ?>" method="GET" class="d-flex gap-2 flex-grow-1 align-items-end flex-wrap">
                            <div style="min-width: 280px; flex-grow: 1; max-width: 400px;">
                                ...
                                <div class="input-group input-group-sm shadow-sm" style="border-radius: 8px; overflow: hidden;">
                                    <span class="input-group-text bg-white border-end-0 text-muted"><i class="fas fa-search"></i></span>
                                    <input type="text" name="search" class="form-control border-start-0 shadow-none ps-0" placeholder="Cari Kode / Nama Aset..." value="<?php echo e(request('search')); ?>">
                                </div>
                            </div>
                            <button type="submit" class="btn btn-primary btn-sm btn-round fw-bold px-4 shadow-sm hover-lift">Filter</button>
                            <a href="<?php echo e(route('operational.inventaris')); ?>" class="btn btn-white btn-sm border btn-round fw-bold text-dark px-4 shadow-sm hover-lift">Reset</a>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $asets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="text-start ps-4">
                                                <span class="badge badge-soft-secondary border text-dark py-2 px-3 fw-bold shadow-sm" style="letter-spacing: 0.5px;"><?php echo e($aset->kode); ?></span>
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="me-3 mt-1 flex-shrink-0">
                                                        <?php if($aset->foto): ?>
                                                            <a href="<?php echo e(asset('storage/' . $aset->foto)); ?>" target="_blank" title="Klik untuk perbesar foto">
                                                                <img src="<?php echo e(asset('storage/' . $aset->foto)); ?>" alt="Foto Aset" class="rounded border shadow-sm hover-lift" style="width: 52px; height: 52px; object-fit: cover;">
                                                            </a>
                                                        <?php else: ?>
                                                    ...
                                                    <div>
                                                        <div class="fw-bolder text-dark mb-1" style="font-size: 14px;"><?php echo e($aset->nama); ?></div>
                                                        <span class="badge badge-soft-info border mb-1" style="font-size: 10px;"><?php echo e($aset->kategori); ?></span>
                                                        
                                                        
                                                        <?php if($aset->keterangan): ?>
                                                            <div class="text-muted fst-italic mt-1 lh-sm text-wrap" style="font-size: 11px; max-width: 250px;">
                                                                <i class="fas fa-info-circle me-1 text-primary opacity-75"></i> <?php echo e($aset->keterangan); ?>
                                            ...
                                            <td>
                                                <h5 class="mb-0 fw-bolder text-dark"><?php echo e($aset->jumlah ?? 1); ?></h5>
                                                <small class="text-muted fw-bold text-uppercase" style="font-size: 10px;"><?php echo e($aset->satuan ?? 'Unit'); ?></small>
                                            </td>
                                            <td>
                                                <?php
                                                ...
                                                <div class="fw-bolder text-success mb-1" style="font-size: 14px;">
                                                    Rp <?php echo e(number_format($totalNilai, 0, ',', '.')); ?>

                                                </div>
                                                
                                                <small class="text-muted fw-medium" style="font-size: 10px;">
                                                    @ Rp <?php echo e(number_format($hargaBeli, 0, ',', '.')); ?> / <?php echo e($aset->satuan ?? 'Unit'); ?>

                                                </small>
                                            </td>
                                            <td>
                                                <div class="fw-bold text-primary mb-1"><i class="fas fa-map-marker-alt me-1 text-danger"></i><?php echo e($aset->lokasi); ?></div>
                                                <small class="text-muted fw-medium"><i class="fas fa-user-tie me-1"></i> PIC: <?php echo e($aset->pic ?? '-'); ?></small>
                                            </td>
                                            <td>
                                                <?php
                                                ...
                                                ?>
                                                <span class="badge <?php echo e($kondisiClass); ?> px-3 py-1 rounded-pill border"><?php echo e($aset->kondisi); ?></span>
                                            </td>
                                            <td class="text-center pe-4">
                                                <div class="d-flex gap-2 justify-content-center">
                                                    ...
                                                    <button class="btn btn-sm btn-light border text-primary btn-round shadow-sm hover-lift px-2" 
                                                            ...
                                                            data-bs-target="#modalEditAset<?php echo e($aset->id); ?>">
                                                        <i class="fas fa-edit"></i>
                                                    </button>

                                                    
                                                    <form action="<?php echo e(route('inventaris.aset.destroy', $aset->id)); ?>" method="POST" class="d-inline form-hapus m-0 p-0">
                                                        <?php echo csrf_field(); ?> 
                ...
                <div class="modal-body px-4 pt-3">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control input-modern shadow-none" name="tgl_masuk" value="<?php echo e(date('Y-m-d')); ?>" required>
                        </div>
                        <div class="col-md-6">
...
<?php $__currentLoopData = $asets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="modal fade" id="modalEditAset<?php echo e($aset->id); ?>" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content card-modern border-0 shadow-lg">
                ...
                <form action="<?php echo e(route('inventaris.aset.update', $aset->id)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="modal-body px-4 pt-3">
                        <div class="row g-3">
                            <div class="col-md-4">
                                <label class="label-modern">Kode Aset <span class="text-danger">*</span></label>
                                <input type="text" class="form-control input-modern shadow-none text-uppercase" name="kode" value="<?php echo e($aset->kode); ?>" required>
                            </div>
                            <div class="col-md-8">
                                <label class="label-modern">Nama Aset / Barang <span class="text-danger">*</span></label>
                                <input type="text" class="form-control input-modern shadow-none" name="nama" value="<?php echo e($aset->nama); ?>" required>
                            </div>
                            
                            <div class="col-md-6">
                                <label class="label-modern">Jumlah Aset <span class="text-danger">*</span></label>
                                <input type="number" class="form-control input-modern shadow-none" name="jumlah" value="<?php echo e($aset->jumlah); ?>" min="1" required>
                            </div>
                            <div class="col-md-6">
                                <label class="label-modern">Satuan <span class="text-danger">*</span></label>
                                <input type="text" class="form-control input-modern shadow-none" name="satuan" value="<?php echo e($aset->satuan); ?>" required>
                            </div>
                            
                            <div class="col-md-6">
                                <label class="label-modern">Kategori Aset <span class="text-danger">*</span></label>
                                <select name="kategori" class="form-select input-modern shadow-none" required>
                                    <option value="Elektronik & IT" <?php echo e($aset->kategori == 'Elektronik & IT' ? 'selected' : ''); ?>>Elektronik & IT</option>
                                    <option value="Furnitur" <?php echo e($aset->kategori == 'Furnitur' ? 'selected' : ''); ?>>Furnitur (Meja, Kursi, dll)</option>
                                    <option value="Kendaraan" <?php echo e($aset->kategori == 'Kendaraan' ? 'selected' : ''); ?>>Kendaraan Operasional</option>
                                    <option value="Perlengkapan Cetak" <?php echo e($aset->kategori == 'Perlengkapan Cetak' ? 'selected' : ''); ?>>Perlengkapan Cetak / ATK</option>
                                    <option value="Lainnya" <?php echo e($aset->kategori == 'Lainnya' ? 'selected' : ''); ?>>Lainnya</option>
                                </select>
                            </div>
                            <div class="col-md-6">
                                <label class="label-modern">Tanggal Masuk / Pembelian <span class="text-danger">*</span></label>
                                <input type="date" class="form-control input-modern shadow-none" name="tgl_masuk" value="<?php echo e($aset->tgl_masuk); ?>" required>
                            </div>
                            <div class="col-md-6">
                                <label class="label-modern">Lokasi Penempatan <span class="text-danger">*</span></label>
                                <input type="text" class="form-control input-modern shadow-none" name="lokasi" value="<?php echo e($aset->lokasi); ?>" required>
                            </div>
                            <div class="col-md-6">
                                <label class="label-modern">Penanggung Jawab (PIC)</label>
                                <input type="text" class="form-control input-modern shadow-none" name="pic" value="<?php echo e($aset->pic); ?>">
                            </div>
                            <div class="col-md-6">
                                <label class="label-modern">Harga Beli (Rp)</label>
                                <input type="number" class="form-control input-modern shadow-none" name="harga" value="<?php echo e($aset->harga); ?>">
                            </div>
                            <div class="col-md-6">
                                <label class="label-modern">Status / Kondisi <span class="text-danger">*</span></label>
                                <select name="kondisi" class="form-select input-modern shadow-none" required>
                                    <option value="Baik" <?php echo e($aset->kondisi == 'Baik' ? 'selected' : ''); ?>>Baik / Baru</option>
                                    <option value="Bekas - Baik" <?php echo e($aset->kondisi == 'Bekas - Baik' ? 'selected' : ''); ?>>Bekas - Masih Layak</option>
                                    <option value="Rusak Ringan" <?php echo e($aset->kondisi == 'Rusak Ringan' ? 'selected' : ''); ?>>Rusak Ringan</option>
                                </select>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <label class="label-modern">Catatan Tambahan</label>
                                <textarea class="form-control input-modern shadow-none" name="keterangan" rows="2"><?php echo e($aset->keterangan); ?></textarea>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="modalTambahPersediaan" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content card-modern border-0 shadow-lg">
            ...
            <form action="<?php echo e(route('inventaris.item.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-body px-4 pt-3">
                    <div class="row g-3">
                        <div class="col-md-12">
...
<?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="modal fade" id="modalEditPersediaan<?php echo e($item->id); ?>" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content card-modern border-0 shadow-lg">
                <div class="modal-header bg-primary-subtle text-primary border-bottom-0 pb-3 pt-4 px-4">
                    <h5 class="modal-title fw-bolder">
                ...
                <form action="<?php echo e(route('inventaris.item.update', $item->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    <div class="modal-body px-4 pt-3">
                        <div class="row g-3">
                            <div class="col-md-12">
                                <label class="label-modern">Nama Barang <span class="text-danger">*</span></label>
                                <input type="text" class="form-control input-modern shadow-none" name="nama_barang" value="<?php echo e($item->nama); ?>" required>
                            </div>
                            <div class="col-md-6">
                                <label class="label-modern">Kategori <span class="text-danger">*</span></label>
                                <select name="kategori" class="form-select input-modern shadow-none" required>
                                    <option value="Atribut Pelatihan" <?php echo e($item->kategori == 'Atribut Pelatihan' ? 'selected' : ''); ?>>Atribut Pelatihan</option>
                                    <option value="ATK & Modul" <?php echo e($item->kategori == 'ATK & Modul' ? 'selected' : ''); ?>>ATK & Modul</option>
                                    <option value="Konsumsi/Pantry" <?php echo e($item->kategori == 'Konsumsi/Pantry' ? 'selected' : ''); ?>>Konsumsi / Pantry</option>
                                    <option value="Lainnya" <?php echo e($item->kategori == 'Lainnya' ? 'selected' : ''); ?>>Lainnya</option>
                                </select>
                            </div>
                            <div class="col-md-6">
                                <label class="label-modern">Satuan Unit <span class="text-danger">*</span></label>
                                <input type="text" class="form-control input-modern shadow-none" name="satuan" value="<?php echo e($item->satuan); ?>" required>
                            </div>
                            <div class="col-md-12">
                                <label class="label-modern">Batas Min. Peringatan <span class="text-danger">*</span></label>
                                <input type="number" class="form-control input-modern shadow-none" name="batas_minimum" value="<?php echo e($item->min_stok); ?>" min="1" required>
                                <small class="text-muted" style="font-size: 10px;">*Stok saat ini: <?php echo e($item->stok); ?> <?php echo e($item->satuan); ?> (Perubahan stok hanya bisa lewat mutasi In/Out)</small>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="modalMutasi<?php echo e($item->id); ?>In" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content card-modern border-0 shadow-lg">
                <div class="modal-header bg-primary-subtle text-primary border-bottom-0 pb-3 pt-4 px-4">
                    <h5 class="modal-title fw-bolder">
                ...
                <form action="<?php echo e(route('inventaris.mutasi', $item->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="tipe" value="in">
                    <div class="modal-body px-4 pt-3">
                        <p class="mb-3 text-dark opacity-75">Barang: <strong class="text-primary"><?php echo e($item->nama); ?></strong></p>
                        <div class="form-group px-0">
                            <label class="label-modern">Jumlah Masuk (<span class="text-lowercase"><?php echo e($item->satuan); ?></span>) <span class="text-danger">*</span></label>
    ...
    <div class="modal fade" id="modalMutasi<?php echo e($item->id); ?>Out" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content card-modern border-0 shadow-lg">
                <div class="modal-header bg-warning-subtle text-warning-dark border-bottom-0 pb-3 pt-4 px-4">
                    <h5 class="modal-title fw-bolder">
                ...
                <form action="<?php echo e(route('inventaris.mutasi', $item->id)); ?>" method="POST">
                    ...
                    <div class="modal-body px-4 pt-3">
                        <div class="alert alert-modern-warning mb-4 py-2 px-3 border-0">
                            Barang: <strong class="text-dark"><?php echo e($item->nama); ?></strong> <br>
                            Sisa stok: <strong class="text-danger"><?php echo e($item->stok); ?></strong> <?php echo e($item->satuan); ?>

                        </div>
                        <div class="form-group px-0">
                            <label class="label-modern">Jumlah Keluar (<span class="text-lowercase"><?php echo e($item->satuan); ?></span>) <span class="text-danger">*</span></label>
                            <input type="number" name="qty" class="form-control input-modern shadow-none" min="1" max="<?php echo e($item->stok); ?>" required placeholder="0">
                        </div>
                        <div class="form-group px-0 mt-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\dashboard-mkt\resources\views/operational/inventaris.blade.php ENDPATH**/ ?>