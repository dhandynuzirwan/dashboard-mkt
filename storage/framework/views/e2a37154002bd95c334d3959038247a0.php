...
<body class="bg-gray-50 text-gray-800 font-sans antialiased selection:bg-blue-200">
    ...
    <div id="sheet-pendaftaran" class="fixed inset-0 z-50 hidden flex items-end md:items-center justify-center">
        ...
        <div id="content-pendaftaran" class="relative bg-white w-full max-w-lg md:rounded-3xl rounded-t-[2rem] shadow-2xl overflow-hidden sheet-enter pb-8 md:pb-0">
            ...
            <div class="p-6 space-y-4">
                <a href="<?php echo e(url('portal/pendaftaran-pribadi')); ?>" class="flex items-center p-4 bg-gray-50 border border-gray-200 rounded-2xl active:bg-blue-50 active:border-blue-300 transition">
                ...
                <a href="<?php echo e(url('portal/pendaftaran-instansi')); ?>" class="flex items-center p-4 bg-gray-50 border border-gray-200 rounded-2xl active:bg-blue-50 active:border-blue-300 transition">
    ...
    <div id="sheet-pantau" class="fixed inset-0 z-50 hidden flex items-end md:items-center justify-center">
        ...
        <div id="content-pantau" class="relative bg-white w-full max-w-lg md:rounded-3xl rounded-t-[2rem] shadow-2xl overflow-hidden sheet-enter pb-8 md:pb-0">
            ...
            <div class="p-6 space-y-4">
                <a href="<?php echo e(url('portal/cek-status')); ?>" class="flex items-center p-4 bg-gray-50 border border-gray-200 rounded-2xl active:bg-emerald-50 active:border-emerald-300 transition">
                ...
                <a href="<?php echo e(url('portal/cek-status-perusahaan')); ?>" class="flex items-center p-4 bg-gray-50 border border-gray-200 rounded-2xl active:bg-emerald-50 active:border-emerald-300 transition">
                    <div class="w-12 h-12 bg-gray-200 text-gray-600 rounded-full flex-shrink-0 flex items-center justify-center mr-4">
...
</html><?php /**PATH C:\laragon\www\dashboard-mkt\resources\views/portal/index.blade.php ENDPATH**/ ?>