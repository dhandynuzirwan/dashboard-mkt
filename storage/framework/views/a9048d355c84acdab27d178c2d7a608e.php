        ...
        <div class="col-md-8">
            <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
                ...
                <div class="card-body p-4 p-md-5 pt-0">
                    <form action="<?php echo e(route('pengajuan-lembur.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            <a href="<?php echo e(route('pengajuan-lembur.index')); ?>" class="btn btn-outline-secondary px-4">Batal</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\dashboard-mkt\resources\views/pengajuan-lembur/create.blade.php ENDPATH**/ ?>