...
<div class="container">
    <div class="page-inner">
            ...
            <div class="alert alert-success alert-dismissible fade show shadow-sm border-0 rounded-4 mb-4" role="alert">
                <div class="d-flex align-items-start">
                    ...
                    <div class="flex-grow-1">
                        <strong class="text-dark">Sukses!</strong> <span class="text-muted"><?php echo e(session('success')); ?></span>
                        
                        <?php if(session('import_stats')): ?>
                            <?php $importStats = session('import_stats'); ?>
                            <div class="mt-2 d-flex flex-wrap gap-2">
                                <span class="badge badge-soft-success p-2 rounded-2">
                                    <i class="fas fa-plus-circle me-1"></i> <?php echo e($importStats['new_prospek']); ?> Prospek Baru
                                </span>
                                <span class="badge badge-soft-info p-2 rounded-2">
                                    <i class="fas fa-sync-alt me-1"></i> <?php echo e($importStats['updated_prospek']); ?> Prospek Diupdate
                                </span>
                                <?php if($importStats['new_cta'] > 0): ?>
                                <span class="badge badge-soft-primary p-2 rounded-2">
                                    <i class="fas fa-file-invoice me-1"></i> <?php echo e($importStats['new_cta']); ?> CTA Baru
                                </span>
                                <?php endif; ?>
                                <?php if($importStats['updated_cta'] > 0): ?>
                                <span class="badge badge-soft-secondary p-2 rounded-2">
                                    <i class="fas fa-edit me-1"></i> <?php echo e($importStats['updated_cta']); ?> CTA Diupdate
                                </span>
                                <?php endif; ?>
                                <?php if($importStats['skipped'] > 0): ?>
                                <span class="badge badge-soft-warning p-2 rounded-2 text-dark">
                                    <i class="fas fa-minus-circle me-1"></i> <?php echo e($importStats['skipped']); ?> Baris Kosong Dilewati
                                </span>
                                <?php endif; ?>
                                <?php if($importStats['failures'] > 0): ?>
                                <span class="badge badge-soft-danger p-2 rounded-2">
                                    <i class="fas fa-times-circle me-1"></i> <?php echo e($importStats['failures']); ?> Baris Gagal
                                </span>
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
                        ...
                        <?php if(session('import_failures') && count(session('import_failures')) > 0): ?>
                            <div class="mt-3 p-3 bg-white rounded-3 border border-warning-subtle shadow-sm">
                                <strong class="text-danger d-block mb-1 small text-uppercase"><i class="fas fa-exclamation-triangle me-1"></i> Detail Baris yang Gagal di-Import (Total: <?php echo e(count(session('import_failures'))); ?>)</strong>
                                <div style="max-height: 150px; overflow-y: auto;">
                                    <ul class="mb-0 pl-3 text-muted small">
                                        <?php $__currentLoopData = session('import_failures'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $failure): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li>Baris <b><?php echo e($failure['row']); ?></b> (<?php echo e($failure['perusahaan']); ?>): <span class="text-danger"><?php echo e($failure['error']); ?></span></li>
        ...
        <?php if(session('error')): ?>
            <div class="alert alert-danger alert-dismissible fade show shadow-sm border-0 rounded-4 mb-4" role="alert">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <strong class="text-dark">Gagal!</strong> <span class="text-muted"><?php echo e(session('error')); ?></span>
                    </div>
                </div>
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
        ...
        <?php if(session('last_import_prospek_ids') || session('last_import_cta_ids')): ?>
            <?php
                $importHash = md5(implode(',', (array)session('last_import_prospek_ids', [])) . '|' . implode(',', (array)session('last_import_cta_ids', [])));
            ?>
            <div id="import-banner" data-import-hash="<?php echo e($importHash); ?>" class="alert alert-modern-warning alert-dismissible fade show shadow-sm border-0 rounded-4 mb-4 d-flex align-items-center justify-content-between p-3" role="alert" style="padding-right: 3.5rem !important;">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <span class="text-muted ms-1">
                            Anda baru saja menambahkan <b><?php echo e(count((array)session('last_import_prospek_ids', []))); ?></b> Prospek & <b><?php echo e(count((array)session('last_import_cta_ids', []))); ?></b> CTA baru. Ingin membatalkannya?
                        </span>
                    </div>
                </div>
                <form action="<?php echo e(route('prospek.undo-import')); ?>" method="POST" class="m-0">
                    <?php echo csrf_field(); ?>
        ...
        <div class="card card-modern mb-4 fade-in">
            <div class="card-body p-3 p-md-4">
                ...
                <form action="<?php echo e(route('prospek.index')); ?>" method="GET" class="row g-3 align-items-end">
                    <div class="col-sm-6 col-md-3 col-lg-2">
                        <label class="label-modern">Dari Tanggal</label>
                        <input type="date" name="start_date" class="form-control form-control-sm input-modern" value="<?php echo e($start); ?>">
                    </div>
                    <div class="col-sm-6 col-md-3 col-lg-2">
                        <label class="label-modern">Sampai Tanggal</label>
                        <input type="date" name="end_date" class="form-control form-control-sm input-modern" value="<?php echo e($end); ?>">
                    </div>
                    <div class="col-sm-6 col-md-3 col-lg-2">
                        ...
                        <select name="marketing_id" class="form-select form-select-sm input-modern">
                            ...
                            <?php $__currentLoopData = $marketings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($m->id); ?>" <?php echo e(request('marketing_id') == $m->id ? 'selected' : ''); ?>><?php echo e($m->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="col-sm-6 col-md-3 col-lg-2">
                        ...
                        <select name="sumber_tipe" class="form-select form-select-sm input-modern">
                            ...
                            <option value="ads" <?php echo e(request('sumber_tipe') == 'ads' ? 'selected' : ''); ?>>Ads / Iklan</option>
                            <option value="organik" <?php echo e(request('sumber_tipe') == 'organik' ? 'selected' : ''); ?>>Organik (Non-Ads)</option>
                        </select>
                    </div>
                    <div class="col-sm-6 col-md-3 col-lg-2">
                        ...
                        <select name="cta_status" class="form-select form-select-sm input-modern">
                            ...
                            <option value="pending" <?php echo e(request('cta_status') == 'pending' ? 'selected' : ''); ?>>🚩 Belum di-CTA</option>
                            <option value="done" <?php echo e(request('cta_status') == 'done' ? 'selected' : ''); ?>>✅ Sudah di-CTA</option>
                        </select>
                    </div>
                    <div class="col-sm-6 col-md-3 col-lg-2">
                        ...
                        <select name="status" class="form-select form-select-sm input-modern">
                            ...
                            <option value="hold" <?php echo e(request('status') == 'hold' ? 'selected' : ''); ?>>Hold</option>
                            <option value="kalah_harga" <?php echo e(request('status') == 'kalah_harga' ? 'selected' : ''); ?>>Kalah Harga</option>
                            
                            <option value="cancel" <?php echo e(request('status') == 'cancel' ? 'selected' : ''); ?>>Cancel</option>
                            
                            <option value="deal" <?php echo e(request('status') == 'deal' ? 'selected' : ''); ?>>Deal</option>
                        </select>
                    </div>
                    <div class="col-sm-12 col-md-6 col-lg-3">
                        ...
                        <select name="status_akhir" class="form-select form-select-sm input-modern">
                            <option value="">Semua Status</option>
                            <option value="belum_ada_status" <?php echo e(request('status_akhir') == 'belum_ada_status' ? 'selected' : ''); ?>>⚠️ Belum Ada Status</option>
                            <?php $__currentLoopData = $all_status_akhir; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(!empty($status)): ?>
                                    <option value="<?php echo e($status); ?>" <?php echo e(request('status_akhir') == $status ? 'selected' : ''); ?>><?php echo e($status); ?></option>
                                <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="col-sm-12 col-md-6 col-lg-3">
                        ...
                        <select name="status_harga" class="form-select form-select-sm input-modern">
                            ...
                            <option value="sudah_diisi" <?php echo e(request('status_harga') == 'sudah_diisi' ? 'selected' : ''); ?>>Sudah Diisi Harga</option>
                            <option value="belum_diisi" <?php echo e(request('status_harga') == 'belum_diisi' ? 'selected' : ''); ?>>Belum Diisi Harga</option>
                        </select>
                    </div>
                    <div class="col-sm-12 col-md-6 col-lg-9 d-flex gap-2 justify-content-md-end mt-4 mt-md-0">
                        ...
                        <a href="<?php echo e(route('prospek.index')); ?>" class="btn btn-white btn-sm btn-round fw-bold border px-4 hover-lift text-dark">
                ...
                <div class="card card-modern h-100 hover-lift">
                    <div class="card-body p-3 p-xl-4 d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h3 class="fw-bolder text-dark mb-0 lh-1"><?php echo e(number_format($stats['total_prospek'])); ?></h3>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body p-3 p-xl-4 d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-end justify-content-between">
                                <h3 class="fw-bolder text-dark mb-0 lh-1"><?php echo e(number_format($stats['total_cta'])); ?></h3>
                                <span class="badge badge-soft-info" style="font-size: 10px;">
                                    <?php echo e($stats['total_prospek'] > 0 ? round(($stats['total_cta'] / $stats['total_prospek']) * 100, 1) : 0); ?>% Rate
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card card-modern h-100 hover-lift border-success-subtle border-2">
                    <div class="card-body p-3 p-xl-4 d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h4 class="fw-bolder text-dark mb-0 lh-1">Rp <?php echo e(number_format($stats['total_nilai'], 0, ',', '.')); ?></h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card card-modern h-100 hover-lift">
                    <div class="card-body p-3 p-xl-4 d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-end justify-content-between">
                                <h3 class="fw-bolder text-dark mb-0 lh-1"><?php echo e(number_format($stats['total_deal'])); ?></h3>
                                <span class="badge badge-soft-warning" style="font-size: 10px;">
                                    <?php echo e($stats['total_cta'] > 0 ? round(($stats['total_deal'] / $stats['total_cta']) * 100, 1) : 0); ?>% Closing
                                </span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-3 fade-in">
            <div class="d-flex gap-2">
                ...
                <?php if(session('last_import_prospek_ids') || session('last_import_cta_ids')): ?>
                    <form action="<?php echo e(route('prospek.undo-import')); ?>" method="POST" class="d-inline m-0">
                        <?php echo csrf_field(); ?>
                ...
                <?php endif; ?>
                <a href="<?php echo e(route('prospek.check')); ?>" class="btn btn-white btn-sm btn-round border fw-bold text-dark shadow-sm hover-lift">
                    <i class="fas fa-sync-alt text-primary me-1"></i> Cek Sinkronisasi
                </a>
            </div>
            
            <div class="col-md-4 col-12">
                <form action="<?php echo e(route('prospek.index')); ?>" method="GET" class="input-group shadow-sm" style="border-radius: 20px; overflow: hidden;">
                    ...
                    <input type="hidden" name="marketing_id" value="<?php echo e(request('marketing_id')); ?>">
                    <input type="hidden" name="status_akhir" value="<?php echo e(request('status_akhir')); ?>">
                    <input type="hidden" name="status" value="<?php echo e(request('status')); ?>">
                    <input type="hidden" name="cta_status" value="<?php echo e(request('cta_status')); ?>">

                    <span class="input-group-text bg-white border-end-0 text-muted px-3"><i class="fas fa-search"></i></span>
                    <input type="text" name="search_perusahaan" class="form-control border-start-0 border-end-0 ps-0 shadow-none" placeholder="Cari Nama Perusahaan..." value="<?php echo e(request('search_perusahaan')); ?>">
                    
                    <?php if(request('search_perusahaan')): ?>
                        <a href="<?php echo e(route('prospek.index', request()->except('search_perusahaan'))); ?>" class="btn btn-white border-start-0 border-top border-bottom text-danger">
        ...
        <?php if(isset($duplicateGroups) && $duplicateGroups->count() > 0): ?>
            ...
            <div class="d-flex align-items-start">
                ...
                <div class="flex-grow-1">
                    ...
                    <p class="mb-3 small text-dark opacity-75">
                        Terdapat <b class="text-danger"><?php echo e($duplicateGroups->count()); ?> kelompok perusahaan</b> dengan nama dan lokasi yang sama. Harap bersihkan data agar laporan tetap akurat.
                    </p>
                    ...
                    <div class="collapse mt-3" id="collapseDuplicates">
                        <div class="card card-body bg-white border-0 shadow-sm p-0 rounded-4 overflow-hidden">
                            <form action="<?php echo e(route('prospek.massDelete')); ?>" method="POST">
                                ...
                                <div class="table-responsive" style="max-height: 400px; overflow-y: auto;">
                                    <table class="table table-modern table-hover mb-0">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $duplicateGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupName => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td colspan="6" class="bg-danger-subtle text-danger fw-bold border-bottom-0 py-2">
                                                        <i class="fas fa-building me-1"></i> <?php echo e($groupName); ?> 
                                                        <span class="badge bg-danger ms-2 rounded-pill"><?php echo e($items->count()); ?> Data Sama</span>
                                                    </td>
                                                </tr>
                                                <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td class="text-center align-middle">
                                                            <input type="checkbox" name="selected_prospek[]" value="<?php echo e($item->id); ?>" class="form-check-input border-danger">
                                                        </td>
                                                        <td class="align-middle">
                                                            <span class="fw-bold text-dark"><?php echo e($item->perusahaan); ?></span><br>
                                                            <small class="text-muted"><i class="fas fa-map-marker-alt me-1 text-danger"></i><?php echo e($item->lokasi ?? '-'); ?></small>
                                                        </td>
                                                        <td class="align-middle text-dark fw-medium">
                                                            <?php echo e($item->marketing->name ?? 'Belum Diassign'); ?>

                                                        </td>
                                                        <td class="align-middle">
                                                            <span class="text-dark fw-medium"><?php echo e($item->created_at->format('d M Y')); ?></span><br>
                                                        ...
                                                        <td class="align-middle">
                                                            <span class="fw-bold text-dark"><?php echo e($item->status ?? '-'); ?></span>
                                                            <small class="text-muted d-block text-truncate" style="max-width: 200px;">
                                                                <?php echo \Illuminate\Support\Str::autoLink($item->catatan ?? 'Tidak ada catatan'); ?>

                                                            </small>
                                                        </td>
                                                        <td class="text-center align-middle">
                                                            <a href="<?php echo e(route('prospek.edit', $item->id)); ?>" target="_blank" class="btn btn-sm btn-white border text-primary rounded-pill hover-lift shadow-sm px-3">Detail</a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php if(isset($duplicateCtaGroups) && $duplicateCtaGroups->count() > 0): ?>
        <div class="alert alert-modern-warning mb-4 fade-in">
            <div class="d-flex align-items-start">
                ...
                <div class="flex-grow-1">
                    ...
                    <p class="mb-3 small text-dark opacity-75">
                        Terdapat <b class="text-danger"><?php echo e($duplicateCtaGroups->count()); ?> kelompok penawaran</b> dengan Perusahaan dan Judul yang sama persis.
                    </p>
                    ...
                    <div class="collapse mt-3" id="collapseDuplicateCTA">
                        <div class="card card-body bg-white border-0 shadow-sm p-0 rounded-4 overflow-hidden">
                            <form action="<?php echo e(route('cta.massDelete')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="table-responsive" style="max-height: 400px; overflow-y: auto;">
                                    <table class="table table-modern table-hover mb-0">
                                        <thead class="bg-light sticky-top">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $duplicateCtaGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupName => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td colspan="6" class="bg-warning-subtle text-dark fw-bold border-bottom-0 py-2">
                                                        <i class="fas fa-file-invoice-dollar me-1 text-warning-dark"></i> <?php echo e($groupName); ?> 
                                                        <span class="badge bg-warning text-dark ms-2 rounded-pill"><?php echo e($items->count()); ?> Data Sama</span>
                                                    </td>
                                                </tr>
                                                <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td class="text-center align-middle">
                                                            <input type="checkbox" name="selected_cta[]" value="<?php echo e($item->id); ?>" class="form-check-input border-warning">
                                                        </td>
                                                        <td class="align-middle">
                                                            <span class="fw-bold text-primary"><?php echo e($item->judul_permintaan ?? '-'); ?></span><br>
                                                            <span class="badge badge-soft-info my-1"><?php echo e(strtoupper($item->sertifikasi ?? 'NON-SERTIFIKASI')); ?></span><br>
                                                            <small class="text-dark fw-medium d-block text-truncate" style="max-width: 230px;"><?php echo e($item->skema ?? '-'); ?></small>
                                                        </td>
                                                        <td class="align-middle">
                                                            <div class="d-flex justify-content-between mb-1 small">
                                                                <span class="text-muted">Hrg Jual:</span>
                                                                <span class="text-success fw-bold">Rp <?php echo e(number_format($item->harga_penawaran, 0, ',', '.')); ?></span>
                                                            </div>
                                                            <div class="d-flex justify-content-between pt-1 border-top small">
                                                                <span class="text-muted fw-bold">Total (<?php echo e($item->jumlah_peserta); ?> Org):</span>
                                                                <span class="text-dark fw-bolder">Rp <?php echo e(number_format(($item->harga_penawaran ?? 0) * ($item->jumlah_peserta ?? 1), 0, ',', '.')); ?></span>
                                                            </div>
                                                        </td>
                                                        <td class="align-middle">
                                                            <span class="badge bg-dark rounded-pill mb-1"><?php echo e(strtoupper($item->status_penawaran ?? '-')); ?></span>
                                                            <small class="text-muted d-block text-truncate" style="max-width: 200px;">
                                                                <?php echo \Illuminate\Support\Str::autoLink($item->keterangan ?? 'Tidak ada keterangan'); ?>

                                                            </small>
                                                        </td>
                                                        <td class="align-middle">
                                                            <span class="fw-bold text-dark"><?php echo e($item->created_at->format('d M Y')); ?></span><br>
                                                            <small class="text-muted"><?php echo e($item->created_at->format('H:i')); ?> WIB</small>
                                                            <?php if($index === 0): ?>
                                                                <br><span class="badge badge-soft-success mt-1">Asli (Tertua)</span>
                                                            <?php else: ?>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <a href="<?php echo e(route('cta.edit', $item->id)); ?>" target="_blank" class="btn btn-sm btn-white border text-primary rounded-pill hover-lift shadow-sm px-3">Detail</a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="tab-content mt-2 mb-3" id="pills-tabContent">
            ...
            <div class="tab-pane fade show active" id="pills-prospek" role="tabpanel">
                <div class="card card-modern border-0 shadow-sm mb-4">
                    <div class="card-body p-0">
                        <form action="<?php echo e(route('prospek.massDelete')); ?>" method="POST" id="formMassDelete">
                            <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                            
                            <?php if(in_array(auth()->user()->role, ['superadmin', 'admin', 'spv_marketing'])): ?>
                                ...
                                <table class="table table-modern table-hover align-middle mb-0">
                                    <thead class="bg-light">
                                        <tr>
                                            ...
                                            <th width="250">
                                                <a href="<?php echo e(route('prospek.index', array_merge(request()->query(), [
                                                    'sort_by' => 'perusahaan',
                                                    ...
                                                    PERUSAHAAN
                                                    <i class="fas <?php echo e(request('sort_by') == 'perusahaan' ? (request('sort_order') == 'asc' ? 'fa-sort-alpha-down' : 'fa-sort-alpha-up') : 'fa-sort text-muted opacity-50'); ?>"></i>
                                                </a>
                                            </th>
                                            <th>PIC & KONTAK</th>
                                            <th>MARKETING & CTA</th>
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $prospeks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                <td class="text-center align-middle">
                                                    <input type="checkbox" name="selected_prospek[]" value="<?php echo e($data->id); ?>" class="form-check-input checkItemProspek shadow-none">
                                                </td>
                                                <td class="align-middle">
                                                    <span class="fw-bold text-primary">#<?php echo e($data->id); ?></span><br>
                                                    <small class="text-muted fw-medium"><?php echo e($data->tanggal_prospek ? \Carbon\Carbon::parse($data->tanggal_prospek)->format('d M Y') : '-'); ?></small>
                                                </td>
                                                <td class="align-middle">
                                                    <div class="fw-bolder text-dark mb-1" style="font-size: 14px;"><?php echo e($data->perusahaan); ?></div>
                                                    <small class="text-muted d-block text-truncate mb-1" style="max-width: 230px;">
                                                        <i class="fas fa-map-marker-alt text-danger"></i> <?php echo e($data->lokasi ?? '-'); ?>

                                                    </small>
                                                    <span class="badge badge-soft-info" style="font-size: 10px;"><?php echo e($data->sumber); ?></span>
                                                </td>
                                                <td class="align-middle">
                                                    <div class="fw-bold text-dark"><?php echo e($data->nama_pic); ?></div>
                                                    <small class="text-muted d-block mb-2"><?php echo e($data->jabatan); ?></small>
                                                    
                                                    <div class="d-flex flex-column gap-2" style="font-size: 12px;">
                                                        
                                                        <?php if($data->wa_pic): ?> 
                                                            <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $data->wa_pic)); ?>" target="_blank" class="text-success fw-bold text-decoration-none hover-lift">
                                                                <i class="fab fa-whatsapp me-1"></i> <?php echo e($data->wa_pic); ?>
                                                        ...
                                                        <?php if($data->telp): ?> 
                                                            <a href="tel:<?php echo e(preg_replace('/[^0-9]/', '', $data->telp)); ?>" class="text-primary fw-bold text-decoration-none hover-lift">
                                                                <i class="fas fa-phone-alt me-1"></i> <?php echo e($data->telp); ?>
                                                        ...
                                                        <?php if($data->email): ?> 
                                                            <a href="https://mail.google.com/mail/?view=cm&fs=1&to=<?php echo e($data->email); ?>" target="_blank" class="text-secondary fw-bold text-decoration-none hover-lift">
                                                                <i class="fas fa-envelope me-1"></i> <?php echo e($data->email); ?>
                                                ...
                                                <td class="align-middle">
                                                    <div class="d-flex align-items-center mb-1">
                                                        ...
                                                        <span class="fw-bold text-dark"><?php echo e($data->marketing?->name ?? '-'); ?></span>
                                                    </div>
                                                    <?php if(!$data->cta): ?>
                                                ...
                                                <td class="align-middle">
                                                    <span class="fw-bold text-dark d-block mb-1"><?php echo e($data->status); ?></span>
                                                    <small class="text-muted d-block text-wrap mb-1 lh-sm" style="max-width: 200px;">
                                                        <?php echo \Illuminate\Support\Str::autoLink($data->catatan ?? 'Tidak ada catatan...'); ?>

                                                    </small>
                                                    <span class="badge bg-light text-muted border" style="font-size: 9px;"><i class="fas fa-history me-1"></i> Up: <?php echo e($data->update_terakhir ?? '-'); ?></span>
                                                </td>
                                                <td class="text-center align-middle">
                                                    <div class="d-flex flex-column gap-2 justify-content-center px-2">
                                                        <?php if(in_array(auth()->user()->role, ['superadmin', 'admin', 'spv_marketing'])): ?>
                                                            <a href="<?php echo e(route('prospek.edit', $data->id)); ?>" class="btn btn-primary btn-sm btn-round fw-bold shadow-sm">
                                                                Edit
                                                            </a>
                                                        <?php else: ?>
                                                            <?php if(!$data->cta): ?>
                                                                <a href="<?php echo e(route('form-cta', $data->id)); ?>" class="btn btn-success btn-sm btn-round fw-bold shadow-sm">
                    ...
                    <div class="card-footer bg-white border-top-0 pt-4 pb-3">
                        <div class="d-flex justify-content-center">
                            <?php echo e($prospeks->links('partials.pagination')); ?>
            ...
            <div class="tab-pane fade" id="pills-cta" role="tabpanel">
                <div class="card card-modern border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-modern table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $ctaProspeks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <?php
                                            $semuaCta = \App\Models\Cta::where('prospek_id', $data->id)->latest()->get();
                                        ?>
                                        <?php $__currentLoopData = $semuaCta; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemCta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td class="align-middle ps-3">
                                                    <div class="fw-bold text-dark mb-1" style="font-size: 13px;"><?php echo e($data->perusahaan); ?></div>
                                                    <div class="d-flex flex-wrap gap-2 mt-1 mb-2">
                                                        <span class="badge bg-light text-primary border">#<?php echo e($data->id); ?></span>
                                                        <span class="badge bg-light text-muted border"><i class="far fa-calendar-alt me-1"></i><?php echo e($data->tanggal_prospek); ?></span>
                                                    </div>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <small class="text-dark fw-medium"><?php echo e($data->marketing?->name); ?></small>
                                                    </div>
                                                </td>
                                                <td class="align-middle">
                                                    <div class="fw-bold text-primary mb-1"><?php echo e($itemCta->judul_permintaan); ?></div>
                                                    <span class="badge badge-soft-info mb-1"><?php echo e(strtoupper($itemCta->sertifikasi)); ?></span>
                                                    <small class="text-dark d-block fw-medium lh-sm mt-1" style="max-width: 250px;"><?php echo e($itemCta->skema); ?></small>
                                                    <div class="d-flex flex-wrap gap-2 mt-2">
                                                        <span class="badge bg-light text-dark border"><i class="fas fa-users text-muted me-1"></i> <?php echo e($itemCta->jumlah_peserta); ?> Peserta</span>
                                                        <?php if($itemCta->tanggal_pelaksanaan): ?>
                                                            <span class="badge bg-light text-dark border"><i class="far fa-calendar-check text-muted me-1"></i> 
                                                                <?php echo e(\Carbon\Carbon::parse($itemCta->tanggal_pelaksanaan)->format('d M Y')); ?>

                                                                <?php if($itemCta->tanggal_selesai && $itemCta->tanggal_selesai != $itemCta->tanggal_pelaksanaan): ?>
                                                                    - <?php echo e(\Carbon\Carbon::parse($itemCta->tanggal_selesai)->format('d M Y')); ?>
                                                ...
                                                <td class="align-middle">
                                                    <div class="d-flex justify-content-between mb-1 small">
                                                        ...
                                                        <span class="text-success fw-bold">Rp <?php echo e(number_format($itemCta->harga_penawaran, 0, ',', '.')); ?></span>
                                                    </div>
                                                    <div class="d-flex justify-content-between mb-2 small">
                                                        <span class="text-muted">Modal:</span>
                                                        <span class="text-danger fw-bold">Rp <?php echo e(number_format($itemCta->harga_vendor, 0, ',', '.')); ?></span>
                                                    </div>
                                                    <div>
                                                        <?php if($itemCta->file_proposal): ?>
                                                            <a href="<?php echo e(asset('storage/' . $itemCta->file_proposal)); ?>" target="_blank" class="btn btn-sm btn-info btn-round shadow-sm w-100 fw-bold text-white hover-lift">
                                                                <i class="fas fa-file-pdf me-1"></i> PDF File
                                                            </a>
                                                        <?php elseif($itemCta->proposal_link): ?>
                                                            <a href="<?php echo e($itemCta->proposal_link); ?>" target="_blank" class="btn btn-sm btn-primary btn-round shadow-sm w-100 fw-bold hover-lift">
                                                ...
                                                <td class="align-middle">
                                                    ...
                                                    ?>
                                                    <span class="badge <?php echo e($current_status['class']); ?> rounded-pill px-3 mb-2"><?php echo e($current_status['label']); ?></span>
                                                    <small class="text-muted d-block text-wrap lh-sm" style="max-width: 200px;">
                                                        <?php echo \Illuminate\Support\Str::autoLink($itemCta->keterangan ?? 'Tidak Ada Keterangan...'); ?>

                                                    </small>
                                                </td>
                                                <td class="text-center align-middle pe-3">
                                                    <?php if(auth()->id() == $data->marketing_id || in_array(auth()->user()->role, ['superadmin', 'admin', 'spv_marketing'])): ?>
                                                        <a href="<?php echo e(route('cta.edit', $itemCta->id)); ?>" class="btn btn-primary btn-sm btn-round fw-bold shadow-sm w-100 hover-lift">
                                                            Edit
                                                        </a>
                                                    <?php else: ?>
                    ...
                    <div class="card-footer bg-white border-top-0 pt-4 pb-3">
                        <div class="d-flex justify-content-center">
                            <?php echo e($ctaProspeks->links('partials.pagination')); ?>
...
<div class="modal fade" id="requestModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <form action="<?php echo e(route('download.request')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="start_date" value="<?php echo e(request('start_date')); ?>">
            <input type="hidden" name="end_date" value="<?php echo e(request('end_date')); ?>">
            <input type="hidden" name="marketing_id" value="<?php echo e(request('marketing_id')); ?>">
...
<div class="modal fade" id="uploadExcelModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered">
        <form action="<?php echo e(route('prospek.import')); ?>" method="POST" enctype="multipart/form-data" id="uploadExcelForm">
            <?php echo csrf_field(); ?>
            <div class="modal-content border-0 shadow-lg rounded-4">
                <div class="modal-header border-bottom-0 pb-0">
                ...
                <div class="modal-body pt-4">
                    ...
                    <div id="uploadFormInputs">
                        ...
                        <div class="mb-4">
                            ...
                            <a href="<?php echo e(route('prospek.download-template')); ?>" class="btn btn-white border btn-sm btn-round text-primary fw-bold px-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\dashboard-mkt\resources\views/pipeline.blade.php ENDPATH**/ ?>