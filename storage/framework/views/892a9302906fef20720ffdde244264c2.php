    ...
    <div class="page-inner">
        ...
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4 justify-content-between">
            ...
            <div class="mt-3 mt-md-0 d-flex gap-2">
                <?php if(in_array(auth()->user()->role, ['superadmin', 'web_dev', 'graphic'])): ?>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col col-stats ms-3 ms-sm-0">
                                <div class="numbers">
                                    ...
                                    <h4 class="card-title"><?php echo e($totalModul); ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col col-stats ms-3 ms-sm-0">
                                <div class="numbers">
                                    ...
                                    <h4 class="card-title"><?php echo e($totalKemnaker); ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col col-stats ms-3 ms-sm-0">
                                <div class="numbers">
                                    ...
                                    <h4 class="card-title"><?php echo e($totalBnsp); ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col col-stats ms-3 ms-sm-0">
                                <div class="numbers">
                                    ...
                                    <h4 class="card-title"><?php echo e($modulBulanIni); ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-modern table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><strong><?php echo e($log->judul_modul); ?></strong><br><small class="text-muted"><?php echo e($log->kategori); ?> - <?php echo e($log->sertifikasi); ?></small></td>
                                        <td><?php echo e($log->pengupload->name ?? '-'); ?></td>
            ...
            <div class="col-12">
                <div class="d-flex flex-wrap gap-3 p-3 bg-white rounded shadow-sm border border-light">
                    <div class="d-flex align-items-center">
                        ...
                        <div><span class="text-muted d-block" style="font-size: 11px">Total Aktif</span><strong class="fs-5"><?php echo e($totalAktif); ?></strong></div>
                    </div>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div><span class="text-muted d-block" style="font-size: 11px">Total Nonaktif</span><strong class="fs-5"><?php echo e($totalNonaktif); ?></strong></div>
                    </div>
                    <div class="border-start mx-2"></div>
                    <div class="d-flex align-items-center">
                        <div class="icon-sm bg-primary-transparent text-primary rounded-circle text-center me-2"><i class="fas fa-download"></i></div>
                        <div><span class="text-muted d-block" style="font-size: 11px">Total Download</span><strong class="fs-5"><?php echo e($totalDownloadAll); ?></strong></div>
                    </div>
                    <div class="border-start mx-2"></div>
                    <div class="d-flex align-items-center">
                        <div class="icon-sm bg-warning-transparent text-warning rounded-circle text-center me-2"><i class="fas fa-database"></i></div>
                        <div><span class="text-muted d-block" style="font-size: 11px">Total Ukuran File</span><strong class="fs-5"><?php echo e($totalUkuranMB); ?></strong></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card card-round">
            <div class="card-header bg-light">
                ...
                <ul class="nav nav-pills nav-secondary mb-3" id="pills-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request('sertifikasi') == '' ? 'active' : ''); ?>" href="<?php echo e(route('modul.index', array_merge(request()->except('sertifikasi', 'page')))); ?>">Semua</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request('sertifikasi') == 'KEMNAKER' ? 'active' : ''); ?>" href="<?php echo e(route('modul.index', array_merge(request()->except('sertifikasi', 'page'), ['sertifikasi' => 'KEMNAKER']))); ?>">KEMNAKER</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request('sertifikasi') == 'BNSP' ? 'active' : ''); ?>" href="<?php echo e(route('modul.index', array_merge(request()->except('sertifikasi', 'page'), ['sertifikasi' => 'BNSP']))); ?>">BNSP</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request('sertifikasi') == 'UPSKILLS' ? 'active' : ''); ?>" href="<?php echo e(route('modul.index', array_merge(request()->except('sertifikasi', 'page'), ['sertifikasi' => 'UPSKILLS']))); ?>">UPSKILLS</a>
                    </li>
                </ul>

                
                <form method="GET" action="<?php echo e(route('modul.index')); ?>">
                    <input type="hidden" name="sertifikasi" value="<?php echo e(request('sertifikasi')); ?>">
                    <div class="row align-items-end g-2">
                        ...
                        <div class="col-md-2">
                            ...
                            <select name="kategori" class="form-select">
                                ...
                                <?php $__currentLoopData = $listKategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-2">
                            ...
                            <select name="pengajar" class="form-select">
                                ...
                                <?php $__currentLoopData = $listPengajar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($pj); ?>" <?php echo e(request('pengajar') == $pj ? 'selected' : ''); ?>><?php echo e($pj); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="col-md-2">
                            ...
                            <select name="tahun" class="form-select">
                                ...
                                <?php $__currentLoopData = $listTahun; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $thn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($thn); ?>" <?php echo e(request('tahun') == $thn ? 'selected' : ''); ?>><?php echo e($thn); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="col-md-2">
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-modern table-hover mb-0">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $moduls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $modul): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><?php echo e($moduls->firstItem() + $index); ?></td>
                                    <td>
                                        <div class="d-flex flex-column">
                                            <strong class="text-dark fs-6 mb-1"><?php echo e($modul->judul_modul); ?></strong>
                                            <div class="">
                                                <span class="badge badge-soft-info my-1"><i class="fas fa-certificate me-1"></i><?php echo e($modul->sertifikasi); ?></span>
                                                <span class="badge badge-soft-secondary my-1"><i class="fas fa-tag me-1"></i><?php echo e($modul->kategori); ?></span>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex flex-column text-muted" style="font-size: 13px;">
                                            <span class="mb-1"><i class="fas fa-user-tie me-2 text-primary" style="width: 14px;"></i><?php echo e($modul->pengajar); ?></span>
                                            <span class="mb-1"><i class="fas fa-calendar-alt me-2 text-warning" style="width: 14px;"></i>Tahun: <strong><?php echo e($modul->tahun); ?></strong></span>
                                            <span><i class="fas fa-upload me-2 text-success" style="width: 14px;"></i>Upload: <?php echo e($modul->created_at->format('d/m/Y')); ?></span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex flex-column text-muted" style="font-size: 13px;">
                                            <span class="mb-1"><i class="fas fa-file-pdf me-2 text-danger" style="width: 14px;"></i><?php echo e(number_format($modul->ukuran_file / 1048576, 2)); ?> MB</span>
                                            <span><i class="fas fa-download me-2 text-primary" style="width: 14px;"></i><?php echo e($modul->total_download); ?>x Diunduh</span>
                                        </div>
                                    </td>
                                    <td>
                                        <?php if($modul->status == 'Aktif'): ?>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a href="<?php echo e(route('modul.preview', $modul->id)); ?>" target="_blank" class="btn btn-sm btn-info hover-lift" data-bs-toggle="tooltip" title="Preview">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="<?php echo e(route('modul.preview', $modul->id)); ?>?print=true" target="_blank" class="btn btn-sm btn-secondary hover-lift" data-bs-toggle="tooltip" title="Print">
                                                <i class="fas fa-print"></i>
                                            </a>
                                            <a href="<?php echo e(route('modul.download', $modul->id)); ?>" class="btn btn-sm btn-primary hover-lift" data-bs-toggle="tooltip" title="Download">
                                                <i class="fas fa-download"></i>
                                            </a>
                                            <?php if(in_array(auth()->user()->role, ['superadmin', 'web_dev', 'graphic'])): ?>
                                                <button type="button" class="btn btn-sm btn-warning btn-edit hover-lift" data-modul="<?php echo e(json_encode($modul)); ?>" data-bs-toggle="tooltip" title="Edit">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                                <form action="<?php echo e(route('modul.destroy', $modul->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus modul ini?')">
                                                    <?php echo csrf_field(); ?>
...
<div class="modal fade" id="uploadModal" tabindex="-1" aria-labelledby="uploadModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('modul.store')); ?>" method="POST" enctype="multipart/form-data" id="uploadForm">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="tahun" class="form-control" required value="<?php echo e(date('Y')); ?>" min="2000" max="2099">
                        </div>
                        <div class="col-md-6 mb-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\dashboard-mkt\resources\views/modul-pelatihan/index.blade.php ENDPATH**/ ?>