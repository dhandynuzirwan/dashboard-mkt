...
<div class="container">
    <div class="page-inner">
        ...
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row mb-4 justify-content-between fade-in">
            ...
            <?php if(in_array(auth()->user()->role, ['operasional', 'team_leader', 'web_dev'])): ?>
                ...
                <div class="card glass-card h-100 border-0">
                    <div class="card-body p-3 p-xl-4 d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h3 class="fw-bolder text-dark mb-0 lh-1"><?php echo e($totalAktivitas); ?></h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card glass-card h-100 border-0">
                    <div class="card-body p-3 p-xl-4 d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h3 class="fw-bolder text-dark mb-0 lh-1"><?php echo e($totalJamKerja); ?> <span style="font-size: 14px;">Jam</span></h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card glass-card h-100 border-0">
                    <div class="card-body p-3 p-xl-4 d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h3 class="fw-bolder text-dark mb-0 lh-1"><?php echo e($aktivitas->pluck('user_id')->unique()->count()); ?> / <?php echo e($pegawaiOperasional->count()); ?></h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card glass-card h-100 border-0">
                    <div class="card-body p-3 p-xl-4 d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            ...
                            ?>
                            <h3 class="fw-bolder text-dark mb-0 lh-1"><?php echo e($persen); ?>%</h3>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="glass-card mb-4 fade-in" style="background-color: #f8faff;">
            <div class="card-body p-3 p-md-4">
                ...
                <form action="<?php echo e(route('operational.aktivitas-harian')); ?>" method="GET" class="row g-3 align-items-end">
                    <div class="col-sm-6 col-md-2">
                        <label class="label-modern">Dari Tanggal</label>
                        <input type="date" name="start_date" class="form-control form-control-sm input-modern shadow-none" value="<?php echo e($start_date); ?>">
                    </div>
                    <div class="col-sm-6 col-md-2">
                        <label class="label-modern">Sampai Tanggal</label>
                        <input type="date" name="end_date" class="form-control form-control-sm input-modern shadow-none" value="<?php echo e($end_date); ?>">
                    </div>
                    <div class="col-md-4">
                        ...
                        <select name="pegawai_id" class="form-select form-select-sm input-modern shadow-none">
                            <option value="all" <?php echo e($pegawai_id == 'all' ? 'selected' : ''); ?>>Semua Pegawai Operasional</option>
                            <?php $__currentLoopData = $pegawaiOperasional; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pegawai): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($pegawai->id); ?>" <?php echo e($pegawai_id == $pegawai->id ? 'selected' : ''); ?>><?php echo e($pegawai->name); ?></option>
                    ...
                    <div class="col-md-4 d-flex gap-2 mt-4 mt-md-0">
                        ...
                        <a href="<?php echo e(route('operational.aktivitas-harian')); ?>" class="btn btn-light border btn-sm flex-grow-1 btn-round fw-bold shadow-sm hover-lift text-dark px-3 text-center pt-2">
                            Reset
                        </a>
                    </div>
                </form>
        ...
        <div class="glass-card mb-4 fade-in">
            <div class="card-header bg-transparent border-bottom pt-4 px-4 pb-3">
                <h6 class="card-title fw-bolder mb-0 text-dark">
                    Log Aktivitas (<?php echo e(\Carbon\Carbon::parse($start_date)->translatedFormat('d M Y')); ?> - <?php echo e(\Carbon\Carbon::parse($end_date)->translatedFormat('d M Y')); ?>)
                </h6>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="ps-4 py-3">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <span class="fw-bolder text-dark d-block mb-1" style="font-size: 13px;"><?php echo e($log->user->name); ?></span>
                                                <div style="line-height: 1.2;">
                                                    <small class="text-primary fw-bold d-block mb-0" style="font-size: 10px;">
                                                        <i class="far fa-calendar-alt me-1"></i> <?php echo e(\Carbon\Carbon::parse($log->tanggal_aktivitas)->translatedFormat('d M Y')); ?>

                                                    </small>
                                                    <small class="text-muted fw-medium d-block" style="font-size: 10px;">
                                                        <i class="far fa-clock me-1"></i> <?php echo e(\Carbon\Carbon::parse($log->created_at)->format('H:i')); ?> WIB
                                                    </small>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <td class="py-3">
                                        <div class="d-flex align-items-center mb-1">
                                            <div class="fw-bolder text-dark me-2" style="font-size: 14px;"><?php echo e($log->nama_kegiatan); ?></div>
                                        </div>
                                            ...
                                            ?>
                                            <span class="badge <?php echo e($color); ?>" style="font-size: 9px; padding: 3px 8px;"><?php echo e($log->status); ?></span>
                                        <small class="text-muted d-block text-wrap lh-sm" style="max-width: 350px;">
                                            <?php echo e($log->deskripsi ?? 'Tidak ada deskripsi tambahan.'); ?>

                                        </small>
                                    </td>
                                    
                                    <td class="py-3">
                                        <?php if($log->durasi_menit): ?>
                                            <span class="badge badge-soft-info border border-info rounded-pill px-3 py-2 fw-bold text-dark">
                                                <i class="fas fa-hourglass-half text-info me-1"></i> <?php echo e($log->durasi_menit); ?> Menit
                                            </span>
                                        <?php else: ?>
                                    ...
                                    <td class="py-3">
                                        <div class="d-flex flex-wrap gap-2">
                                            <?php if($log->file_evidence): ?>
                                                <a href="<?php echo e(asset('storage/' . $log->file_evidence)); ?>" class="badge badge-soft-success border border-success text-decoration-none px-2 py-1 shadow-sm hover-lift" target="_blank">
                                                    <i class="fas fa-image me-1"></i> Gambar
                                                </a>
                                            <?php endif; ?>
                                            
                                            
                                            <?php if($log->link_evidence): ?>
                                                <a href="<?php echo e($log->link_evidence); ?>" class="badge badge-soft-primary border border-primary text-decoration-none px-2 py-1 shadow-sm hover-lift" target="_blank">
                                                    <i class="fas fa-link me-1"></i> Link URL
                                                </a>
                                            <?php endif; ?>
                                            
                                            <?php if(!$log->file_evidence && !$log->link_evidence): ?>
                                    ...
                                    <td class="text-center pe-4 py-3">
                                        <?php if(auth()->id() == $log->user_id): ?>
                                            <div class="d-flex justify-content-center gap-2">
                                                <button class="btn btn-light border text-primary btn-sm btn-round shadow-sm hover-lift px-3" data-bs-toggle="modal" data-bs-target="#modalEditAktivitas<?php echo e($log->id); ?>">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                                <form action="<?php echo e(route('operational.aktivitas-harian.destroy', $log->id)); ?>" method="POST" class="m-0 p-0 form-hapus">
...
<div class="modal fade" id="modalTambahAktivitas" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content modal-content-modern">
            ...
            <form action="<?php echo e(route('operational.aktivitas-harian.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="modal-body px-4 pt-3">
                    <div class="row g-3">
                        <div class="col-md-4">
                            <label class="label-modern">Tanggal Aktivitas <span class="text-danger">*</span></label>
                            <input type="date" class="form-control input-modern shadow-none" name="tanggal_aktivitas" value="<?php echo e(date('Y-m-d')); ?>" max="<?php echo e(date('Y-m-d')); ?>" required>
                        </div>
                        <div class="col-md-8">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="status" class="form-select input-modern shadow-none" required>
                                ...
                                <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($st); ?>" <?php echo e((isset($log) && $log->status == $st) ? 'selected' : ($st == 'Not Started' ? 'selected' : '')); ?>>
                                        <?php echo e($st); ?>
...
<div class="modal fade" id="modalImportAktivitas" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <form action="<?php echo e(route('aktivitas-harian.import')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="modal-content modal-content-modern">
                <div class="modal-header modal-header-modern">
...
<?php $__currentLoopData = $aktivitas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php if(auth()->id() == $log->user_id || in_array(auth()->user()->role, ['team_leader', 'web_dev', 'superadmin'])): ?>
    <div class="modal fade" id="modalEditAktivitas<?php echo e($log->id); ?>" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content modal-content-modern">
                <div class="modal-header modal-header-modern">
                ...
                <form action="<?php echo e(route('operational.aktivitas-harian.update', $log->id)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                    <div class="modal-body px-4 pt-3">
                        <div class="row g-3">
                            <div class="col-md-4">
                                <label class="label-modern">Tanggal Aktivitas <span class="text-danger">*</span></label>
                                <input type="date" class="form-control input-modern shadow-none" name="tanggal_aktivitas" value="<?php echo e($log->tanggal_aktivitas); ?>" max="<?php echo e(date('Y-m-d')); ?>" required>
                            </div>
                            
                            <div class="col-md-8">
                                <label class="label-modern">Nama Kegiatan <span class="text-danger">*</span></label>
                                <input type="text" class="form-control input-modern shadow-none" name="nama_kegiatan" value="<?php echo e($log->nama_kegiatan); ?>" required>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="status" class="form-select input-modern shadow-none" required>
                                    ...
                                    ?>
                                    <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($st); ?>" <?php echo e($log->status == $st ? 'selected' : ''); ?>>
                                            <?php echo e($st); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <div class="input-group input-group-sm shadow-sm" style="border-radius: 8px; overflow: hidden;">
                                        ...
                                        ?>
                                        <input type="number" class="form-control border-end-0 shadow-none text-center bg-white" name="durasi_jam" value="<?php echo e($jamLama); ?>" placeholder="0" min="0" style="font-size: 13px;">
                                        <span class="input-group-text bg-light text-muted border-start-0" style="font-size: 11px;">Jam</span>
                                    </div>
                                    <div class="input-group input-group-sm shadow-sm" style="border-radius: 8px; overflow: hidden;">
                                        <input type="number" class="form-control border-end-0 shadow-none text-center bg-white" name="durasi_menit" value="<?php echo e($menitLama); ?>" placeholder="0" min="0" max="59" style="font-size: 13px;">
                            ...
                            <div class="col-md-12">
                                <label class="label-modern">Deskripsi Pekerjaan</label>
                                <textarea class="form-control input-modern shadow-none" name="deskripsi" rows="2"><?php echo e($log->deskripsi); ?></textarea>
                            </div>
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <input type="url" class="form-control input-modern shadow-none" name="link_evidence" value="<?php echo e($log->link_evidence); ?>" placeholder="https://docs.google.com/...">
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\dashboard-mkt\resources\views/operational/aktivitas-harian.blade.php ENDPATH**/ ?>