...
<body class="bg-gray-50 text-gray-800 font-sans antialiased">
    ...
    <main class="px-5 py-8 max-w-3xl mx-auto">
        ...
        <form action="<?php echo e(route('portal.pendaftaran.kolektif.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-8" id="formKolektif" onsubmit="submitFormCompany(event)">
            <?php echo csrf_field(); ?>
            
            <input type="hidden" name="cta_id" value="<?php echo e(request('cta_id', $cta_id ?? '')); ?>">
            ...
            <div class="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-gray-100">
                ...
                <div class="space-y-5">
                    ...
                    <div class="input-focus-ring transition-shadow rounded-xl">
                        ...
                        <input type="text" name="perusahaan" class="w-full px-4 py-3.5 border border-gray-200 rounded-xl focus:border-emerald-500 outline-none transition-colors text-gray-700 <?php echo e($perusahaan_default ? 'bg-gray-100 cursor-not-allowed focus:bg-gray-100' : 'bg-gray-50 focus:bg-white'); ?>" 
                            placeholder="Masukkan nama perusahaan..."
                            value="<?php echo e(old('perusahaan', $perusahaan_default)); ?>" 
                            <?php echo e($perusahaan_default ? 'readonly' : ''); ?> required>
                        <?php if($perusahaan_default): ?>
                    ...
                    <div class="input-focus-ring transition-shadow rounded-xl">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="alamat_perusahaan" value="<?php echo e(old('alamat_perusahaan')); ?>" class="w-full pl-11 pr-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:border-emerald-500 outline-none transition-colors" placeholder="Contoh: Jl. Sudirman No. 123, Yogyakarta" required>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="input-focus-ring transition-shadow rounded-xl">
                            ...
                            <input type="text" name="nama_pic" value="<?php echo e(old('nama_pic')); ?>" class="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:border-emerald-500 outline-none transition-colors text-gray-700" placeholder="Nama Anda" required>
                        </div>
                        ...
                        <div class="input-focus-ring transition-shadow rounded-xl">
                            ...
                            <div class="relative">
                                ...
                                <input type="tel" name="wa_pic" value="<?php echo e(old('wa_pic')); ?>" class="w-full pl-12 pr-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:border-emerald-500 outline-none transition-colors" placeholder="8123456789" required>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-gray-100">
                ...
                <div id="peserta-container" class="space-y-6 mb-6">
                    <?php for($i = 0; $i < $jumlah_peserta; $i++): ?>
                    ...
                    <div class="peserta-card bg-gray-50 border border-gray-200 rounded-2xl p-5 relative">
                        <h3 class="text-sm font-bold text-emerald-700 mb-4 flex items-center">
                            <span class="bg-emerald-100 px-2 py-0.5 rounded mr-2 nomor-peserta">#<?php echo e($i + 1); ?></span> Data Karyawan
                        </h3>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div class="input-focus-ring rounded-xl">
                                ...
                                <input type="text" name="peserta[<?php echo e($i); ?>][nama_lengkap]" class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:border-emerald-500 outline-none text-sm" placeholder="Sesuai KTP" required>
                            </div>
                            <div class="input-focus-ring rounded-xl">
                                ...
                                <input type="text" name="peserta[<?php echo e($i); ?>][nik]" class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:border-emerald-500 outline-none text-sm" placeholder="16 Digit NIK" required>
                            </div>
                            <div class="input-focus-ring rounded-xl">
                                <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2 ml-1">Tempat Lahir</label>
                                <input type="text" name="peserta[<?php echo e($i); ?>][tempat_lahir]" class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:border-emerald-500 outline-none text-sm" placeholder="Sesuai KTP">
                            </div>
                            <div class="input-focus-ring rounded-xl">
                                <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2 ml-1">Tanggal Lahir</label>
                                <input type="date" name="peserta[<?php echo e($i); ?>][tanggal_lahir]" class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:border-emerald-500 outline-none text-sm">
                            </div>
                            <div class="input-focus-ring rounded-xl">
                                <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2 ml-1">No. WhatsApp</label>
                                <input type="tel" name="peserta[<?php echo e($i); ?>][no_wa]" class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:border-emerald-500 outline-none text-sm" placeholder="0812xxxx">
                            </div>
                            <div class="input-focus-ring rounded-xl">
                                <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2 ml-1">Alamat Peserta</label>
                                <input type="text" name="peserta[<?php echo e($i); ?>][alamat]" class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:border-emerald-500 outline-none text-sm" placeholder="Sesuai KTP">
                            </div>
                            ...
                            <div class="input-focus-ring rounded-xl">
                                ...
                                <select name="peserta[<?php echo e($i); ?>][training_id]" class="w-full select2-init bg-white border border-gray-200" required>
                                    ...
                                    <?php $__currentLoopData = $trainings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($t->id); ?>" <?php echo e(old('peserta.'.$i.'.training_id') == $t->id ? 'selected' : (count($trainings) == 1 ? 'selected' : '')); ?>><?php echo e($t->nama_training); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
    ...
    <script>
        ...
        const opsiPelatihan = `<?php echo $trainings->map(function($t) { return '<option value="'.$t->id.'">'.$t->nama_training.'</option>'; })->implode(''); ?>`;
        ...
        let indexPeserta = <?php echo e($jumlah_peserta - 1); ?>; 
        let nomorTampil = <?php echo e($jumlah_peserta); ?>;  
...
</html><?php /**PATH C:\laragon\www\dashboard-mkt\resources\views/portal/pendaftaran-kolektif.blade.php ENDPATH**/ ?>