    ...
    <div class="page-inner">
        ...
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row mb-4 justify-content-between fade-in">
            ...
            <div class="ms-md-auto py-2 py-md-0 d-flex gap-2 flex-wrap mt-3 mt-md-0">
                <a href="<?php echo e(route('form-data-masuk')); ?>" class="btn btn-success btn-round fw-bold shadow-sm hover-lift">
                    <i class="fa fa-plus me-1"></i> Tambah Data Masuk
                </a>
                <?php if(in_array(auth()->user()->role, ['admin', 'superadmin', 'rnd'])): ?>
        ...
        <div class="card card-modern mb-4 fade-in" style="background-color: #f8faff;">
            <div class="card-body p-3 p-md-4">
                ...
                <form action="<?php echo e(route('data-masuk.index')); ?>" method="GET" class="row g-3 align-items-end">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-2">
                        ...
                        <input type="date" name="start_date" class="form-control form-control-sm input-modern shadow-none" value="<?php echo e(request('start_date')); ?>">
                    </div>
                    
                    <div class="col-sm-6 col-md-4 col-lg-2">
                        <label class="label-modern">Sampai Tanggal</label>
                        <input type="date" name="end_date" class="form-control form-control-sm input-modern shadow-none" value="<?php echo e(request('end_date')); ?>">
                    </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-2">
                        ...
                        <select name="status_deliver" class="form-select form-select-sm input-modern shadow-none">
                            ...
                            <option value="undelivered" <?php echo e(request('status_deliver') == 'undelivered' ? 'selected' : ''); ?>>🔴 Belum Diassign</option>
                            <option value="delivered" <?php echo e(request('status_deliver') == 'delivered' ? 'selected' : ''); ?>>🟢 Sudah Diassign</option>
                        </select>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-12 d-flex gap-2 justify-content-md-end mt-4 mt-lg-3">
                        ...
                        <a href="<?php echo e(route('data-masuk.index')); ?>" class="btn btn-white btn-sm border btn-round fw-bold text-dark hover-lift px-4 text-center shadow-sm">
                            Reset
                        </a>
                    </div>
                </form>
                ...
                <div class="card card-modern h-100 hover-lift">
                    <div class="card-body p-3 p-xl-4 d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h3 class="fw-bolder text-dark mb-0 lh-1"><?php echo e(number_format($totalData, 0, ',', '.')); ?></h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card card-modern h-100 hover-lift border-info-subtle border-2">
                    <div class="card-body p-3 p-xl-4 d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h3 class="fw-bolder text-dark mb-0 lh-1"><?php echo e(number_format($totalToday, 0, ',', '.')); ?></h3>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body p-3 p-xl-4 d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-end justify-content-between">
                                <h3 class="fw-bolder text-dark mb-0 lh-1"><?php echo e(number_format($dataValid, 0, ',', '.')); ?></h3>
                                <span class="badge badge-soft-success" style="font-size: 10px;"><?php echo e($validPercentage); ?>%</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card card-modern h-100 hover-lift border-secondary-subtle border-2">
                    <div class="card-body p-3 p-xl-4 d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h3 class="fw-bolder text-dark mb-0 lh-1"><?php echo e(number_format($dataConverted, 0, ',', '.')); ?></h3>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="tab-content fade-in" id="pills-tabContent">
            ...
            <div class="tab-pane fade show active" id="pills-umum" role="tabpanel">
                ...
                <?php if(in_array(auth()->user()->role, ['admin', 'superadmin'])): ?>
                    <?php if(count($unsyncedCompanies) > 0): ?>
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <p class="mb-2 small text-dark opacity-75">
                                        Terdapat total <b class="text-danger"><?php echo e(count($unsyncedCompanies)); ?></b> data perusahaan di seluruh database yang statusnya <b>Menunggu Admin</b>, namun <b>sudah ada di data Prospek</b>.
                                    </p>
                                    ...
                                    <div class="bg-white p-2 rounded-4 border border-warning shadow-sm mb-3" style="max-height: 120px; overflow-y: auto;">
                                        ...
                                        <div class="d-flex flex-wrap gap-1">
                                            <?php $__currentLoopData = $unsyncedCompanies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $companyName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <form action="<?php echo e(route('data-masuk.auto-sync')); ?>" method="POST" class="d-inline-block">
                                        <?php echo csrf_field(); ?>
                ...
                <div class="card card-modern shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body p-0">
                        <form action="<?php echo e(route('data-masuk.deliver-massal')); ?>" method="POST" id="formDeliverMassal">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-modern table-hover align-middle mb-0">
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $allData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                <?php if(in_array(auth()->user()->role, ['admin', 'superadmin'])): ?>
                                                    <td class="text-center align-middle">
                                                        <input type="checkbox" name="ids[]" value="<?php echo e($item->id); ?>" class="form-check-input checkItem shadow-none" <?php echo e($item->marketing_id ? 'disabled' : ''); ?>>
                                                    </td>
                                                <?php endif; ?>
                                                ...
                                                <td class="align-middle ps-3">
                                                    ...
                                                    <?php else: ?>
                                                        <span class="badge badge-soft-secondary my-1 border"><?php echo e($item->sumber); ?></span><br>
                                                    <?php endif; ?>
                                                    <small class="text-muted fw-medium"><i class="fas fa-map-marker-alt text-danger me-1"></i><?php echo e($item->lokasi ?? '-'); ?></small>
                                                </td>
                                                
                                                <td class="align-middle">
                                                    <div class="fw-bolder text-primary" style="font-size: 14px;"><?php echo e($item->perusahaan); ?></div>
                                                    <small class="text-muted d-block fw-medium mt-1"><i class="fas fa-building me-1"></i> Unit: <?php echo e($item->unit_bisnis ?? '-'); ?></small>
                                                    
                                                    
                                                    <?php if(isset($existingProspeks) && $existingProspeks->has($item->perusahaan)): ?>
                                                        <?php
                                                        ...
                                                        ?>
                                                        <div class="mt-2 p-2 bg-warning-subtle border border-warning rounded-3" style="font-size: 11px;">
                                                            <div class="fw-bold text-warning-dark mb-1" style="font-size: 10px;"><i class="fas fa-history me-1"></i> PERNAH DIPROSPEK</div>
                                                            <div class="d-flex justify-content-between mb-1">
                                                                <span class="text-muted">Marketing:</span>
                                                                <span class="fw-bold text-dark"><?php echo e($latestProspek->marketing->name ?? '-'); ?></span>
                                                            </div>
                                                            <div class="d-flex justify-content-between mb-1">
                                                                <span class="text-muted">Terakhir:</span>
                                                                <span class="fw-bold text-dark"><?php echo e(\Carbon\Carbon::parse($latestProspek->tanggal_prospek)->format('d M Y')); ?></span>
                                                            </div>
                                                            <div class="d-flex justify-content-between mb-1">
                                                                <span class="text-muted">Status:</span>
                                                                <span class="fw-bold text-info"><?php echo e($latestProspek->status ?? '-'); ?></span>
                                                            </div>
                                                            <div class="mt-1 pt-1 border-top border-warning text-end">
                                                                <span class="badge bg-primary rounded-pill shadow-sm" style="font-size: 9px;"><i class="fas fa-file-alt me-1"></i> <?php echo e($totalCta); ?> Form CTA</span>
                                                            </div>
                                                        </div>
                                                    <?php else: ?>
                                                        <div class="mt-2">
                                                    ...
                                                    <div class="d-flex flex-column gap-1" style="font-size: 12px;">
                                                        <?php if($item->email): ?>
                                                            <div title="Email" class="d-flex align-items-center">
                                                                <i class="fas fa-envelope text-secondary me-2"></i> <span class="text-dark fw-medium"><?php echo e($item->email); ?></span>
                                                                <?php if($item->status_email): ?> <span class="badge badge-soft-secondary ms-2" style="font-size: 9px;"><?php echo e($item->status_email); ?></span> <?php endif; ?>
                                                            </div>
                                                        <?php endif; ?>
                                                        <?php if($item->telp): ?> 
                                                            <div title="Telp Perusahaan" class="d-flex align-items-center"><i class="fas fa-phone text-primary me-2"></i> <span class="text-dark fw-medium"><?php echo e($item->telp); ?></span></div> 
                                                        <?php endif; ?>
                                                        <?php if($item->wa_baru ?? $item->wa_pic): ?> 
                                                            <div title="WhatsApp" class="d-flex align-items-center"><i class="fab fa-whatsapp text-success me-2 fs-6"></i> <span class="text-dark fw-medium"><?php echo e($item->wa_baru ?? $item->wa_pic); ?></span></div> 
                                                        <?php endif; ?>
                                                    </div>
                                                </td>

                                                <td class="align-middle text-start">
                                                    <?php if($item->marketing): ?>
                                                        <?php if(!in_array($item->perusahaan, $prospekList)): ?>
                                                            <span class="badge badge-soft-warning border border-warning" title="Data ini nyangkut! Assigned tapi tidak ada di Pipeline">
                                                                <i class="fas fa-exclamation-triangle text-warning-dark me-1"></i> Nyangkut (<?php echo e($item->marketing->name); ?>)
                                                            </span>
                                                        <?php else: ?>
                                                            <span class="badge badge-soft-info border border-info px-3 py-1">
                                                                <i class="fas fa-user-check me-1"></i> <?php echo e($item->marketing->name); ?>
                                                ...
                                                <td class="text-center align-middle pe-3">
                                                    <div class="d-flex flex-column gap-2 justify-content-center">
                                                        ...
                                                        <?php if(in_array($role, ['admin', 'superadmin'])): ?>
                                                            <?php if(!$item->marketing): ?>
                                                                <button type="button" class="btn btn-primary btn-sm btn-round w-100 fw-bold shadow-sm hover-lift" data-bs-toggle="modal" data-bs-target="#modalDeliver<?php echo e($item->id); ?>">
                                                        ...
                                                        <?php if(in_array($role, ['rnd', 'digitalmarketing'])): ?>
                                                            <a href="<?php echo e(route('data-masuk.edit', $item->id)); ?>" class="btn btn-warning text-dark btn-sm w-100 btn-round fw-bold shadow-sm hover-lift"><i class="fa fa-edit"></i> Edit</a>
                                                            <button type="button" onclick="if(confirm('Hapus data ini?')) document.getElementById('delete-form-<?php echo e($item->id); ?>').submit();" class="btn btn-danger btn-sm w-100 btn-round fw-bold shadow-sm hover-lift">
                                        ...
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                            <tr>
                                                <td colspan="<?php echo e(in_array(auth()->user()->role, ['admin', 'superadmin']) ? 6 : 5); ?>" class="text-center py-5 text-muted">
                        ...
                        <div class="card-footer bg-white border-top-0 pt-4 pb-3">
                            <div class="d-flex justify-content-center">
                                <?php echo e($allData->links('partials.pagination')); ?> 
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
            ...
            <div class="tab-pane fade" id="pills-ads" role="tabpanel">
                <div class="card card-modern shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-modern table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $adsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="text-center align-middle ps-4">
                                            <span class="fw-bold text-dark"><?php echo e($ad->created_at->format('d M Y')); ?></span><br>
                                            <span class="badge badge-soft-primary border mt-1 mb-1"><?php echo e($ad->channel_akuisisi); ?></span><br>
                                            <small class="text-muted fw-medium"><i class="fas fa-tag me-1"></i><?php echo e($ad->jenis_klien); ?></small>
                                        </td>
                                        <td class="align-middle">
                                            <div class="fw-bolder text-primary" style="font-size: 14px;"><?php echo e($ad->nama_perusahaan); ?></div>
                                            <small class="text-dark fw-bold d-block mt-1"><i class="fas fa-user-tie me-1 text-muted"></i><?php echo e($ad->nama_hrd); ?></small>
                                            
                                            
                                            <?php if(isset($existingProspeks) && $existingProspeks->has($ad->nama_perusahaan)): ?>
                                                <?php
                                                ...
                                                <div class="mt-2 p-2 bg-warning-subtle border border-warning rounded-3" style="font-size: 11px;">
                                                    ...
                                                    <div class="d-flex justify-content-between mb-1">
                                                        <span class="text-muted">Marketing:</span>
                                                        <span class="fw-bold text-dark"><?php echo e($latestProspekAds->marketing->name ?? '-'); ?></span>
                                                    </div>
                                                    <div class="d-flex justify-content-between mb-1">
                                                        <span class="text-muted">Terakhir:</span>
                                                        <span class="fw-bold text-dark"><?php echo e(\Carbon\Carbon::parse($latestProspekAds->tanggal_prospek)->format('d M Y')); ?></span>
                                                    </div>
                                                    <div class="d-flex justify-content-between mb-1">
                                                        <span class="text-muted">Status:</span>
                                                        <span class="fw-bold text-info"><?php echo e($latestProspekAds->status ?? '-'); ?></span>
                                                    </div>
                                                    <div class="mt-1 pt-1 border-top border-warning text-end">
                                                        <span class="badge bg-primary rounded-pill shadow-sm" style="font-size: 9px;"><i class="fas fa-file-alt me-1"></i> <?php echo e($totalCtaAds); ?> Form CTA</span>
                                                    </div>
                                                </div>
                                            <?php else: ?>
                                                <div class="mt-2">
                                        ...
                                        <td class="align-middle">
                                            <div class="d-flex flex-column gap-1" style="font-size: 12px;">
                                                <div title="WA HRD" class="d-flex align-items-center"><i class="fab fa-whatsapp text-success me-2 fs-6"></i> <span class="text-dark fw-medium"><?php echo e($ad->wa_hrd); ?></span></div>
                                                <div title="Email HRD" class="d-flex align-items-center"><i class="fas fa-envelope text-secondary me-2"></i> <span class="text-dark fw-medium"><?php echo e($ad->email); ?></span></div>
                                            </div>
                                        </td>
                                        <td class="align-middle">
                                            <span class="badge badge-soft-info border mb-2"><?php echo e($ad->jenis_sertifikasi); ?></span><br>
                                            <small class="text-dark d-block fw-medium lh-sm"><?php echo e(Str::limit($ad->kebutuhan_program, 60)); ?></small>
                                        </td>
                                        <td class="text-center align-middle pe-4">
                                            <div class="d-flex flex-column gap-2 justify-content-center align-items-center">
                                                ...
                                                <?php if(in_array($role, ['admin', 'superadmin'])): ?>
                                                    <?php if(!$ad->marketing_id): ?>
                                                        <button class="btn btn-primary btn-sm btn-round w-100 fw-bold shadow-sm hover-lift" data-bs-toggle="modal" data-bs-target="#modalDeliverAds<?php echo e($ad->id); ?>">
                                                            <i class="fas fa-paper-plane me-1"></i> Deliver
                                                        </button>
                                                    <?php else: ?>
                                                ...
                                                <?php if(in_array($role, ['rnd', 'digitalmarketing'])): ?>
                                                    <a href="<?php echo e(route('ads.edit', $ad->id)); ?>" class="btn btn-warning text-dark btn-sm w-100 btn-round fw-bold shadow-sm hover-lift"><i class="fa fa-edit"></i> Edit</a>
                                                    <form action="<?php echo e(route('ads.destroy', $ad->id)); ?>" method="POST" class="d-inline w-100">
                    ...
                    <?php if($adsData->hasPages()): ?>
                    <div class="card-footer bg-white border-top-0 pt-4 pb-3">
                        <div class="d-flex justify-content-center">
                            <?php echo e($adsData->links('partials.pagination')); ?> 
                        </div>
                    </div>
                    <?php endif; ?>
                </div>
...
<div class="modal fade" id="modalDeleteByDate" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <form action="<?php echo e(route('data-masuk.destroy-by-date')); ?>" method="POST">
            <?php echo csrf_field(); ?>
        ...
        <div class="modal-content card-modern border-0 shadow-lg text-start">
            ...
            <div class="modal-body px-4 pt-3">
                ...
                <div class="mb-2">
                    ...
                    <input type="date" name="tanggal_assign" form="formDeliverMassal" class="form-control input-modern shadow-none" value="<?php echo e(date('Y-m-d')); ?>" required>
...
<?php if(in_array(auth()->user()->role, ['admin', 'superadmin'])): ?>
    <?php $__currentLoopData = $allData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if(!$item->marketing): ?>
        <div class="modal fade" id="modalDeliver<?php echo e($item->id); ?>" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <form action="<?php echo e(route('data-masuk.deliver', $item->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="modal-content card-modern border-0 shadow-lg text-start">
                        <div class="modal-header bg-primary-subtle text-primary border-bottom-0 pb-3 pt-4 px-4">
                        ...
                        <div class="modal-body px-4 pt-3">
                            <p class="small text-muted mb-4">Assign perusahaan <b class="text-dark"><?php echo e(Str::limit($item->perusahaan, 40)); ?></b> ke Pipeline.</p>
                            ...
                            <div class="mb-2">
                                <label class="label-modern">Tanggal Assign <span class="text-danger">*</span></label>
                                <input type="date" name="tanggal_assign" class="form-control input-modern shadow-none" value="<?php echo e(date('Y-m-d')); ?>" required>
                            </div>
                        </div>
                        <div class="modal-footer bg-light border-top-0 pt-3 pb-3 px-4 rounded-bottom-4">
                            <button type="button" class="btn btn-white border btn-round fw-bold text-dark hover-lift" data-bs-dismiss="modal">Batal</button>
...
<?php if(in_array(auth()->user()->role, ['admin', 'superadmin'])): ?>
    <?php $__currentLoopData = $adsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if(!$ad->marketing_id): ?>
        <div class="modal fade" id="modalDeliverAds<?php echo e($ad->id); ?>" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <form action="<?php echo e(route('ads.deliver', $ad->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="modal-content card-modern border-0 shadow-lg text-start">
                        <div class="modal-header bg-primary-subtle text-primary border-bottom-0 pb-3 pt-4 px-4">
                        ...
                        <div class="modal-body px-4 pt-3">
                            <p class="small text-muted mb-4">Assign prospek dari ads <b class="text-dark"><?php echo e(Str::limit($ad->nama_perusahaan, 40)); ?></b> ke Pipeline.</p>
...
<?php if(in_array(auth()->user()->role, ['rnd', 'digitalmarketing'])): ?>
    <?php $__currentLoopData = $allData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <form id="delete-form-<?php echo e($item->id); ?>" action="<?php echo e(route('data-masuk.destroy', $item->id)); ?>" method="POST" class="d-none">
            <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
        </form>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\dashboard-mkt\resources\views/data-masuk.blade.php ENDPATH**/ ?>