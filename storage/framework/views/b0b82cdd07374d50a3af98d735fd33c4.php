                ...
                <form action="#" method="GET" class="row g-3 align-items-end">
                    ...
                    <div class="col-md-12 col-lg-6 mt-3 mt-lg-0">
                        <div class="d-flex gap-2 h-100 align-items-end justify-content-lg-end">
                            ...
                            <a href="<?php echo e(route('operational.data-pendaftaran')); ?>" class="btn btn-light border btn-round fw-bold text-dark shadow-sm d-flex align-items-center justify-content-center" style="padding: 8px 20px; font-size: 13px;">
                                Reset
                            </a>
                        </div>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if(!empty($komentar)): ?>
                                                <?php $__currentLoopData = ['superadmin' => ['bg' => 'primary', 'icon' => 'user-shield'], 'spv_marketing' => ['bg' => 'warning', 'icon' => 'bullhorn'], 'team_leader' => ['bg' => 'info', 'icon' => 'users']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role => $cfg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <?php endif; ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <button class="btn btn-sm btn-light border shadow-sm fw-bold w-100 text-dark mt-1" data-bs-toggle="modal" data-bs-target="#modalUpdateKomentarProspek-<?php echo e($deal->id); ?>">
                                            ...
                                            <?php else: ?>
                                                <div class="bg-light border border-dashed p-3 rounded-4 text-center">
                                                    ...
                                                    <button class="btn btn-sm btn-light border btn-round shadow-sm hover-lift text-dark fw-bold px-3" data-bs-toggle="modal" data-bs-target="#modalUpdateKomentarProspek-<?php echo e($deal->id); ?>">
                                            ...
                                            <div class="modal fade text-start" id="modalUpdateKomentarProspek-<?php echo e($deal->id); ?>" tabindex="-1" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <form action="<?php echo e(route('operational.pendaftaran.update-komentar', $deal->id)); ?>" method="POST" class="modal-content modal-content-modern">
                                                        <?php echo csrf_field(); ?>
                                        ...
                                        <td>
                                            ...
                                            <div class="modal fade text-start" id="modalUpdateStatusVendor-<?php echo e($deal->first_cta_id); ?>" tabindex="-1" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <form action="<?php echo e(route('operational.pendaftaran.update-status-vendor', $deal->first_cta_id)); ?>" method="POST" class="modal-content modal-content-modern">
                                                        <?php echo csrf_field(); ?>
                                                        <?php echo method_field('PUT'); ?>
                                                        <div class="modal-header modal-header-modern" >
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center pe-4">
                                            <div class="d-flex flex-column gap-1">
                                                ...
                                                <?php endif; ?>
                                                <?php else: ?>
                                                <button class="btn btn-premium btn-sm w-100 btn-round fw-bold shadow-sm" data-bs-toggle="modal" data-bs-target="#modalReviewIndividu-<?php echo e($pendaftar->id); ?>">
