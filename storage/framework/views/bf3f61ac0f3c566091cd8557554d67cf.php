...
<body class="bg-gray-50 text-gray-800 font-sans antialiased">
    ...
    <main class="px-5 py-8 max-w-3xl mx-auto">
        ...
        <form action="<?php echo e(route('portal.pendaftaran.store')); ?>" method="POST" enctype="multipart/form-data" id="formPendaftaran" class="space-y-8">
            <?php echo csrf_field(); ?>

            <input type="hidden" name="cta_id" value="<?php echo e($cta_id); ?>">
            ...
            <div class="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-gray-100">
                ...
                <div class="space-y-5">
                    <div class="input-focus-ring transition-shadow rounded-xl">
                        ...
                        <input type="text" name="nama_lengkap" value="<?php echo e(old('nama_lengkap')); ?>" required class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:border-blue-500 outline-none transition-colors" placeholder="Contoh: Dhandy Nuzirwan">
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="input-focus-ring transition-shadow rounded-xl">
                            ...
                            <input type="date" name="tanggal_lahir" value="<?php echo e(old('tanggal_lahir')); ?>" required class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:border-blue-500 outline-none transition-colors text-gray-700">
                        </div>
                        ...
                        <div class="input-focus-ring transition-shadow rounded-xl">
                            ...
                            <div class="relative">
                                ...
                                <input type="tel" name="no_wa" value="<?php echo e(old('no_wa')); ?>" required class="w-full pl-12 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:border-blue-500 outline-none transition-colors" placeholder="8123456789" >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="input-focus-ring transition-shadow rounded-xl">
                            ...
                            <select name="master_training_id" class="form-select" required>
                                <?php if($selected_training): ?>
                                    <option value="<?php echo e($selected_training->id); ?>" selected><?php echo e($selected_training->nama_training); ?></option>
                                <?php else: ?>
                                    ...
                                    <?php $__currentLoopData = $trainings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($t->id); ?>" <?php echo e(old('master_training_id') == $t->id ? 'selected' : ''); ?>><?php echo e($t->nama_training); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                            </select>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="input-focus-ring transition-shadow rounded-xl">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="perusahaan" value="<?php echo e(old('perusahaan')); ?>" class="w-full pl-9 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:border-blue-500 outline-none transition-colors" placeholder="Tempat bekerja saat ini">
                            </div>
                        </div>

                        <div class="input-focus-ring transition-shadow rounded-xl">
                            <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2 ml-1">Alamat Perusahaan (Opsional)</label>
                            <input type="text" name="alamat_perusahaan" value="<?php echo e(old('alamat_perusahaan')); ?>" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:border-blue-500 outline-none transition-colors" placeholder="Kota/Kabupaten">
                        </div>
                    </div>
                    ...
                    <div class="space-y-4 bg-blue-50/50 p-4 rounded-2xl border border-blue-50">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4">
                            <label class="flex items-center p-3 bg-white border border-gray-200 rounded-xl cursor-pointer hover:border-blue-300 transition-colors flex-1">
                                <input type="radio" name="opsi_ppn" value="tanpa_ppn" class="w-4 h-4 text-blue-600 focus:ring-blue-500" <?php echo e(old('opsi_ppn', 'tanpa_ppn') == 'tanpa_ppn' ? 'checked' : ''); ?> onchange="toggleNpwp()">
                                <span class="ml-2 text-sm text-gray-700 font-medium">Tanpa PPN</span>
                            </label>
                            
                            <label class="flex items-center p-3 bg-white border border-gray-200 rounded-xl cursor-pointer hover:border-blue-300 transition-colors flex-1">
                                <input type="radio" name="opsi_ppn" value="dengan_ppn" class="w-4 h-4 text-blue-600 focus:ring-blue-500" <?php echo e(old('opsi_ppn') == 'dengan_ppn' ? 'checked' : ''); ?> onchange="toggleNpwp()">
                        ...
                        <div id="npwp-container" class="hidden input-focus-ring transition-all duration-300 ease-in-out rounded-xl mt-3">
                            ...
                            <input type="text" id="input_npwp" name="npwp" value="<?php echo e(old('npwp')); ?>" maxlength="16" class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:bg-white focus:border-blue-500 outline-none transition-colors" placeholder="Masukkan 16 digit angka NPWP">
...
</html><?php /**PATH C:\laragon\www\dashboard-mkt\resources\views/portal/pendaftaran-pribadi.blade.php ENDPATH**/ ?>