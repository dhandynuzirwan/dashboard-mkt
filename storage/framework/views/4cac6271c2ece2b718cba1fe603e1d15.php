...
<div class="container-fluid py-2 tv-monitor-mode bg-light" id="monitor-container" style="min-height: 100vh; min-width: 1600px; overflow-x: hidden;">
    ...
    <div class="d-flex justify-content-between align-items-center mb-1 fade-in px-2" id="monitor-header">
        ...
        <div class="d-flex gap-3 align-items-center">
            ...
            <!-- KEMBALI BUTTON -->
            <a href="<?php echo e(route('monitoring.pelatihan')); ?>" class="btn btn-outline-danger btn-round shadow-lg px-3 py-2 fw-bold hover-lift fs-5" id="btn-back">
...
<script>
    ...
    function loadMonitorData() {
        fetch('<?php echo e(route('api.monitoring.pelatihan.tv-data')); ?>')
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\dashboard-mkt\resources\views/operational/monitor-tv.blade.php ENDPATH**/ ?>